...
Vývojáři budou upozorněni e-mailem, pokud byl některý z jejich podgrafů označen jako neaktivní, a to 7 dní před jeho odstraněním. Pokud si přejí svůj podgraf "aktivovat", mohou tak učinit dotazem v hřišti graphQL svého podgrafu Hosted Service. Vývojáři mohou archivovaný podgraf kdykoli znovu nasadit, pokud je znovu potřeba.
