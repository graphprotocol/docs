...
Pokud hledáte flexibilnější způsob ladění/testování dotazů, jsou k dispozici další podobné webové nástroje, například [Altair](https://altair.sirmuel.design/) a [GraphiQL](https://graphiql-online.com/graphiql).
...
[GraphQL ESLint](https://github.com/dotansimha/graphql-eslint) vám pomůže udržet si přehled o nejlepších postup GraphQL bez většího úsilí.

[Nastavení konfigurace "operations-recommended"](https://github.com/dotansimha/graphql-eslint#available-configs) prosadí základní pravidla, jako jsou:
