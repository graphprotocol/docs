...
- **Manifest podgrafů**: Soubor JSON, který popisuje schéma podgrafu v jazyce GraphQL, zdroje dat a další metadata. [Tady](https://github.com/graphprotocol/example-subgraph/blob/master/subgraph.yaml) je příklad.
