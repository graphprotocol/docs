...
Tato kuchařka vyžaduje [yarn](https://yarnpkg.com/), [závislosti potřebné pro vývoj lokálních Substreamů](https://substreams.streamingfast.io/developers-guide/installation-requirements) a nejnovější verzi Graph CLI (>=0.52.0):
...
> V současné době Subgraph Studio a The Grafu síť podporují subgrafy poháněné substreamy, které indexují mainnet (Mainnet Ethereum).
