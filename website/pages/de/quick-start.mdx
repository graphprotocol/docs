...
Weitere Informationen zum Schreiben Ihres Subgraphen finden Sie unter [Erstellen eines Untergraphen](/developing/creating-a-subgraph).
...
Weitere Informationen zum Abfragen von Daten aus Ihrem Subgraphen finden Sie [here](../querying/querying-the-graph/).
