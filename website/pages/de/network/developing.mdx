...
- Veröffentlichte Subgraphs haben eine entsprechende NFT, die den Besitz des Subgraphs definiert. Sie können [den Besitz eines Subgraphen übertragen](/managing/transfer-a-subgraph/), indem Sie die NFT senden.
...
Wenn Sie einen veröffentlichten Subgraph nicht mehr benötigen, können Sie [ablehnen](/managing/deprecate-a-subgraph/) oder [ ihn übertragen](/managing/transfer-a-subgraph/).Das Verwerfen eines Subgraphs gibt jedes signalisierte GRT an. Die Aufhebung eines Subgraphs gibt alle signalisierten GRT an  [Kuratoren](/network/curating/) zurück.
