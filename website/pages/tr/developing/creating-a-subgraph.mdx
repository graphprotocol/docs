...
Dosya veri kaynakları, IPFS ile başlayarak, sağlam, gebişletilebilir bir şekilde indeksleme sırasında zincir dışı verilerine erişmek için yeni bir subgraph işlevselliğidir.
...
#### Türü file/ipfs olan yeni bir şablonlu veri kaynağı ekleyin: `kind: file/ipfs`
