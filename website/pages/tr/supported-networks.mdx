...
\*\* Graph Düğümü ile entegrasyon: `evm`, `near`, `cosmos`, `osmosis` ve `ar`, Graph Düğümü'nde yerel işleyici ve tür desteğine sahiptir. Firehose ve Substreams ile uyumlu zincirler, genelleştirilmiş [Substreams destekli subgraph](/subgraphs/cookbook/substreams-powered-subgraphs/) entegrasyonundan yararlanabilir (bu, `evm` ve `near` ağlarını içerir). &#8288;<sup>†</sup> [Substreams destekli subgraph'lerin](/subgraphs/cookbook/substreams-powered-subgraphs/) yayına alınmasını destekler.
