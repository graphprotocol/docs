...
Farklı bir zincir tipiyle ilgileniyorsanız Graph Node ile yeni bir entegrasyon kurulmalıdır. Önerilen yaklaşımımız, söz konusu zincir için yeni bir Firehose geliştirmek ve ardından bu Firehose'un Graph Node ile entegrasyonunu sağlamaktır. Daha fazla bilgi aşağıda yer almaktadır.
