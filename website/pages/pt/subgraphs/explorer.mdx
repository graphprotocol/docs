...
- Seus próprios subgraphs completos
...
Quando clicar em um subgraph, será possível:
...
Na tabela de Indexadores, pode-se ver os parâmetros de delegação de um Indexador; sua participação; quanto eles investiram em cada subgraph; e a receita que obtiveram com taxas de query e recompensas de indexação.
...
- Alocado — O stake que os Indexadores estão a alocar de forma ativa aos subgraphs que indexam.
...
Os Curadores analisam subgraphs para identificar os de maior qualidade. Quando um Curador achar um subgraph atraente, ele pode curá-lo com sinais na sua bonding curve. Ao fazer isso, os Curadores avisam aos Indexadores quais subgraphs têm qualidade alta e merecem ser indexados.
...
<div sx={{ mx: 'auto', maxWidth: '400px' }}>![Detalhes da carteira](/img/Wallet-Details.png)</div>
