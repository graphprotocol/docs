...
- Para configurar o faturamento com cartões de crédito ou débito, os utilizadores podem acessar o Subgraph Studio. (https://thegraph.com/studio/)
...
4. Use o slider para estimar o número de queries que espera fazer mensalmente.
   - Para sugestões sobre o número de queries a usar, veja a nossa página de **Perguntas Frequentes**.
...
1. Vá para a [página de cobrança do Subgraph Studio](https://thegraph.com/studio/subgraphs/billing/).
2. Clique em "Connect Wallet" (Conectar Carteira) no canto superior direito, selecione a sua carteira e clique em "Connect" (Conectar). Se usar o Gnosis-Safe, poderá conectar a sua multisig além da sua carteira de assinatura. Depois, assine a mensagem associada. Isto não custa gas.
