...
3. (Só para o Ethereum) Quando os curadores queimam as suas ações para sacar GRT, o valor das ações restantes em GRT é diminuído. Perceba que, em alguns casos, os curadores podem decidir queimar todas as suas ações <strong x-id="1">de uma vez só</strong>. Isto pode ser comum se um programador de dApp parar de atualizar/melhorar as versões do seu subgraph e fazer queries nele, ou se um subgraph falhar. Portanto, é possível que os curadores restantes só sacarão uma fração do seu GRT inicial. Para um papel de rede com um perfil de risco menor, veja <a href="/network/delegating">Delegantes</a>.
