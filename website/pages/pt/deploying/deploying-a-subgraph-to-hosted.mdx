...
Para ilustrar este método, vamos supor que um subgraph deve ser lançado à mainnet e à Sepolia, com uso de diferentes endereços de contratos. Então, daria para definir dois arquivos de config ao fornecer os endereços para cada rede:
...
Para lançar este subgraph à mainnet ou à Sepolia, só precisaria executar um dos seguintes comandos:
