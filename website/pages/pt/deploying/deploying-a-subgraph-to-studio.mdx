...
Há uma CLI para lançar subgraphs ao [Subgraph Studio](https://thegraph.com/studio/). Aqui estão os comandos para instalar a `graph-cli`. Isto pode ser feito com npm ou yarn.
