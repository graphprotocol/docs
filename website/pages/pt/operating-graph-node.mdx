...
#### Escalamento de banco de dados via sharding
...
- O repositório de indexer tem [uma referência de exemplo do Kubernetes](https://github.com/graphprotocol/indexer/tree/main/k8s)
...
- Fazer números grandes de `eth_calls` como parte de handlers
