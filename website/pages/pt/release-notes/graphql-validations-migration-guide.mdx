...
(Campos em conflito com argumentos)
...
(Espalhamento de fragment inválido)
...
(A diretiva não pode ser usada neste local)
...
(A diretiva só pode ser usada neste local uma vez)
