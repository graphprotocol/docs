...
A rede descentralizada do The Graph tem uma redução de custo de 60 a 90% em relação à execução de infraestrutura dedicada, como visto [nestes estudos](https://thegraph.com/docs/en/network/benefits/#low-volume-user-less-than-30-000-queries-per-month).
...
Há bolsas de migração disponíveis a projetos, para curar subgraphs (a fim de atrair Indexadores) e pagar por taxas iniciais de query (candidate-se [aqui](https://thegraph.typeform.com/to/Zz8UAPri?typeform-source=thegraph.com)), um [canal direto](http://thegraph.com/discord) de ajuda a engenheiros, e campanhas de publicidade prioritárias para exibir o seu projeto após a migração, exempladas nestes fios do Twitter: [1](https://twitter.com/graphprotocol/status/1496891582401814537), [2](https://twitter.com/graphprotocol/status/1491926128302379008), & [3](https://twitter.com/graphprotocol/status/1491126245396201473).
...
Há bolsas de migração para cobrir os custos dos primeiros migrantes. Candidate-se [aqui](mailto:migration@thegraph.foundation).
...
Sim: 1% da curadoria sinalizada. O 1% é dividido igualmente entre Curadores (0.5%) e programadores de subgraph (0.5%). Então, para cada 10.000 GRT sinalizados, atualizar custa 50 GRT aos programadores de subgraph.
