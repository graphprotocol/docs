...
Nesta fase, não haverá mais como lançar novos subgraphs no serviço hospedado para aquela rede. Os programadores ainda poderão atualizar subgraphs existentes no serviço hospedado.
...
#### Fase 2 (Claro do Sol): Desativar atualizações de subgraph

Nesta fase, as atualizações a subgraphs devem ser feitas através do Subgraph Studio e então editadas à rede descentralizada. Os subgraphs no serviço hospedado para redes nesta fase continuarão a existir e serão disponíveis a queries, mas os subgraphs devem ser atualizados na rede descentralizada do The Graph.
...
O custo da rede descentralizada do The Graph é de 60 a 90% menor do que a execução de uma infraestrutura dedicada, como visto [nestes estudos de caso](https://thegraph.com/docs/en/network/benefits/#low-volume-user-less-than-30000-queries-per-month).
...
Esperava-se que a Ethereum começaria a sair do serviço hospedado até o fim do terceiro trimestre de 2022, mas isto foi [adiado](https://thegraph.com/blog/transitioning-to-decentralized-graph-network) para cuidar do feedback dos usuários. O prazo da transição da Ethereum será definido por mais melhorias à experiência do utilizador, cobranças, e outros atendimentos de pedidos de utilizadores. Fique atento ao início da fase Raio de Sol da Ethereum através do rastreador do estado da integração abaixo, e através do [Twitter do The Graph.](https://twitter.com/graphprotocol)
...
| Rede                   | Anúncio de integração na Graph Network | Integração de rede completa | Fase 1: Desativar novos subgraphs no serviço hospedado | Fase 2: Desativar atualizações de subgraph no serviço hospedado | Fase 3: Desativar novos subgraphs no serviço hospedado |
| ---------------------- |:--------------------------------------:|:---------------------------:|:------------------------------------------------------:|:---------------------------------------------------------------:|:------------------------------------------------------:|
| Ethereum               |                   ✓                    |              ✓              |                                                        |                                                                 |                                                        |
...
### Há bolsas de migração para subgraphs que migram cedo à Graph Network?

Sim. Para se candidatar para uma bolsa, entre em contacto [aqui](mailto:migration@thegraph.foundation).

### O ecossistema do The Graph oferece algum suporte financeiro/técnico/publicitário pelo processo de migração?

Há bolsas de migração disponíveis para a curadoria de subgraphs (a fim de atrair Indexadores) e pagamento de taxas iniciais de queries (candidate-se [aqui](https://thegraph.typeform.com/to/Zz8UAPri?typeform-source=thegraph.com)), um [canal directo](https://discord.gg/graphprotocol) para ajudar engenheiros em cada passo, e campanhas de marketing de prioridade para demonstrar o seu projecto após a migração, com exemplos nestas postagens do Twitter: [1](https://twitter.com/graphprotocol/status/1496891582401814537), [2](https://twitter.com/graphprotocol/status/1491926128302379008) & [3](https://twitter.com/graphprotocol/status/1491126245396201473).
...
Há bolsas de rede para cobrir os custos dos primeiros migrantes. Candidate-se [aqui](mailto:migration@thegraph.foundation).
...
### Há um custo para atualizar o meu subgraph?

Sim: 1% da curadoria sinalizada. O 1% é dividido igualmente entre Curadores (0.5%) e programadores de subgraph (0.5%). Então, para cada 10.000 GRT sinalizados, o custo de atualizar um subgraph é de 50 GRT por programador.

### Como posso acelerar a sincronização?
