...
O Serviço Hospedado será encerrado no primeiro trimestre de 2023. Veja o anúncio [aqui](https://thegraph.com/blog/sunsetting-hosted-service). Todos os dApps que usam o Serviço Hospedado estão convidados a se atualizarem e migrarem à rede descentralizada. Bolsas de Rede estão disponíveis para ajudar os programadores a a migrarem os seus subgraphs à Graph Network. Se o seu dApp atualizar um subgraph, pode se candidatar [aqui](https://thegraph.typeform.com/to/Zz8UAPri?typeform-source=thegraph.com).

## 28. Como atualizar um subgraph na mainnet?

Se for um programador de subgraph, podes atualizar para uma versão nova do seu subgraph no Studio com a CLI. Ela será privada por enquanto, mas se estiver contente, pode editá-la no Graph Explorer descentralizado. Isto criará uma nova versão do seu subgraph sobre a qual Curadores podem começar a sinalizar.
