...
The Graph nunca cobrará pelo Serviço Hospedado. Este é um protocolo descentralizado, e cobrar por um serviço centralizado não bate com os valores do Graph. O Serviço Hospedado sempre foi um degrau temporário para chegar à rede descentralizada; os programadores terão tempo suficiente para migrar à rede descentralizada quando estiverem confortáveis.

## 27. Quando o Serviço Hospedado será encerrado?

O Serviço Hospedado será encerrado no primeiro trimestre de 2023. Veja o anúncio [aqui](https://thegraph.com/blog/sunsetting-hosted-service). Todos os dApps que usam o Serviço Hospedado podem migrar à rede descentralizada. Para ajudar no processo, há Bolsas de Migração disponíveis para programadores. Se o seu dApp migrar um subgraph, pode se candidatar [aqui](https://thegraph.typeform.com/to/Zz8UAPri?typeform-source=thegraph.com).

## 28. Como atualizar um subgraph na mainnet?

Se for um programador de subgraph, pode atualizar para uma versão nova do seu subgraph no Studio com a CLI. Será privada por enquanto, mas se estiver contente com ela, pode publicá-la no Graph Explorer descentralizado. Isto criará uma nova versão do seu subgraph sobre a qual Curadores podem começar a sinalizar.
