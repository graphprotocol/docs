...
A [documentação do Substreams](/substreams/) te ensinará como construir módulos do Substreams.
...
Veja a [documentação dos módulos](https://substreams.streamingfast.io/developers-guide/modules) para mais detalhes.
