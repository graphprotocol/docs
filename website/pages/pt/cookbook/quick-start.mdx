...
Quando o seu subgraph for lançado ao Subgraph Studio, estiver testado, e estiver pronto para produção, pode então ser publicado na rede descentralizada.

No Subgraph Studio, clique no seu subgraph. Na página do subgraph, clique no botão Publish (publicar) no canto superior direito.
