...
Para saber mais sobre o Substreams, veja a [documentação oficial](/substreams/introduction/).

## O que são subgraphs movidos por substreams?

[Subgraphs movidos pelo Substreams](/subgraphs/cookbook/substreams-powered-subgraphs/) trazem o poder do Substreams aos queries de subgraphs. Ao publicar um subgraph movido pelo Substreams, os dados produzidos pelas transformações do Substreams podem [produzir mudanças de entidade](https://github.com/streamingfast/substreams-sink-entity-changes/blob/develop/substreams-entity-change/src/tables.rs) compatíveis com entidades de subgraph.
...
Para aprender como empacotar subgraphs e lançá-los no The Graph, veja a [documentação sobre subgraphs movidos pelo Substreams](/subgraphs/cookbook/substreams-powered-subgraphs/).
...
Após [definir](/subgraphs/cookbook/substreams-powered-subgraphs/) um subgraph movido pelo Substreams, pode-se usar a Graph CLI para lançá-lo np [Subgraph Studio](https://thegraph.com/studio/).
