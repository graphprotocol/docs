...
- **Indexador de Atualização**: Um Indexador temporário desenhado para atuar como um porto-seguro para queries de subgraph que não são serviçadas por outros Indexadores na rede. O Indexador de atualização não compete com outros Indexadores.
