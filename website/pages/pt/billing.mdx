...
Para um guia em vídeo sobre como depositar GRT no seu saldo de cobrança com uma carteira de cripto, assista este [vídeo](https://youtu.be/4Bw2sh0FxCg).
...
Esta seção mostrará-lhe como adquirir GRT para pagar taxas de query.
...
Esta seção mostrará-lhe como adquirir Ethereum (ETH) para pagar por taxas de transação ou gas. É necessário ter ETH para executar operações na rede Ethereum, como a transferência de tokens ou interação com contratos.
...
8.  Confirme a sua compra, e o ETH será comprado com sucesso.
9.  Pode transferir o ETH da sua conta à sua carteira de cripto, como o [MetaMask](https://metamask.io/).
    - Para transferir o ETH à sua carteira de cripto, clique no botão "Contas" no canto superior direito da página.
...
9.  Pode transferir o ETH da sua conta à sua carteira de cripto, como o [MetaMask](https://metamask.io/).
    - Para transferir o ETH à sua carteira de cripto, adicione o endereço da sua carteira à whitelist de saques.
