...
Alguns utilizadores podem precisar atualizar subgraphs. Devido às taxas de gas do Ethereum, há um custo de cerca de $50 por atualização até o fechamento desta publicação.
...
Comece a usar a Graph Network hoje, e aprenda como [migrar ou lançar o seu subgraph](https://thegraph.com/blog/how-to-migrate-ethereum-subgraph).
