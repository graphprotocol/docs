...
Assim como toda programação de subgraph, isto começa com desenvolvimento e testes locais. Os programadores podem usar o mesmo setup local para construir o seu subgraph — seja ao construir para a Graph Network ou um Graph Node local, com `graph-cli` e o `graph-ts`. Vale usar ferramentas como o [Matchstick](https://github.com/LimeChain/matchstick) para testes de unidades, para deixar os subgraphs mais robustos.
