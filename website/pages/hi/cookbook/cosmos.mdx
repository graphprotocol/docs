...
सब-ग्राफ में मैसेज डिकोड करने का एक उदहारण [यहाँ](https://github.com/graphprotocol/example-subgraphs/blob/main/cosmos/validator-delegations/src/decoding.ts) से देखें|
...
[ब्लॉक फ़िल्टर उदहारण](https://github.com/graphprotocol/example-subgraphs/tree/main/cosmos/block-filtering)

[सत्यापनकर्ता इनाम उदाहरण](https://github.com/graphprotocol/example-subgraphs/tree/main/cosmos/validator-rewards)

[सत्यापनकर्ता प्रतिनिधि मंडल उदाहरण](https://github.com/graphprotocol/example-subgraphs/tree/main/cosmos/validator-delegations)

[ऑस्मोसिस टोकन अदला-बदली उदाहरण](https://github.com/graphprotocol/example-subgraphs/tree/main/cosmos/osmosis-token-swaps)
