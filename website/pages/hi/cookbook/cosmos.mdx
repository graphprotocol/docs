...
सबग्राफ में संदेश डेटा को डिकोड करने का एक उदाहरण [यहां](https://github.com/graphprotocol/graph-tooling/blob/main/examples/cosmos-validator-delegations/src/decoding.ts) पाया जा सकता है।
