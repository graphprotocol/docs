...
### एक स्थानीय ग्राफ़ नोड के साथ NEAR को अनुक्रमण करना
...
[NEAR ब्लॉक्स](https://github.com/graphprotocol/example-subgraphs/tree/main/near/blocks-example)

[NEAR रेसिप्टस](https://github.com/graphprotocol/example-subgraphs/tree/main/near/receipts-example)
...
### क्या एक सबग्राफ इंडेक्स NEAR और EVM दोनों श्रृंखलाओं का हो सकता है?
...
### क्या मैपिंग के दौरान NEAR सबग्राफ NEAR खातों में व्यू कॉल कर सकते हैं?

यह समर्थित नहीं है। हम मूल्यांकन कर रहे हैं कि अनुक्रमण के लिए यह कार्यक्षमता आवश्यक है या नहीं।

### क्या मैं अपने NEAR सबग्राफ में डेटा सोर्स टेम्प्लेट का उपयोग कर सकता हूँ?

यह वर्तमान में समर्थित नहीं है। हम मूल्यांकन कर रहे हैं कि अनुक्रमण के लिए यह कार्यक्षमता आवश्यक है या नहीं।

### एथेरियम सबग्राफ "पेंडिंग" और "करंट" संस्करणों का समर्थन करते हैं, मैं एक NEAR सबग्राफ के "पेंडिंग" संस्करण को कैसे तैनात कर सकता हूं?
...
### मेरे प्रश्न का उत्तर नहीं दिया गया है, मुझे NEAR सबग्राफ बनाने में और सहायता कहां से मिल सकती है?
