...
इंडेक्सर्स The Graph नेटवर्क में नोड ऑपरेटर होते हैं जो इंडेक्सिंग और क्वेरी प्रोसेसिंग सेवाएँ प्रदान करने के लिए ग्राफ टोकन (GRT) स्टेक करते हैं। इंडेक्सर्स अपनी सेवाओं के लिए क्वेरी शुल्क और इंडेक्सिंग रिवॉर्ड कमाते हैं। उन्हें एक लौटाव संख्या के अनुसार रिबेटेड क्वेरी शुल्क भी कमाते हैं, जो कि एक घातांकीय रिबेट फंक्शन के अनुसार होते हैं।
...
एक आवंटन बंद कर दिया गया होने पर, रिबेट्स इंडेक्सर द्वारा दावा किए जाने के लिए उपलब्ध होते हैं। दावा करने पर, क्वेरी फी रिबेट्स को इंडेक्सर और उनके डिलीगेटर्स को क्वेरी फी कट और घातांकीय रिबेट फंक्शन के आधार पर वितरित किया जाता है।
...
- **queryFeeCut** - क्वेरी फी रिबेट्स का वितरण जो इंडेक्सर को होगा। यदि यह 95% पर सेट किया गया है, तो जब एक आवंटन बंद होता है तो इंडेक्सर 95% की क्वेरी फी कमाई प्राप्त करेगा और बाकी 5% डिलीगेटर्स को जाएगा।

- **indexingRewardCut** - इंडेक्सिंग रिवॉर्ड्स का वितरण जो इंडेक्सर को होगा। यदि यह 95% पर सेट किया गया है, तो जब एक आवंटन बंद होता है तो इंडेक्सर 95% के इंडेक्सिंग रिवॉर्ड्स प्राप्त करेगा और बाकी 5% डिलीगेटर्स को वितरित होंगे।
...
- `ग्राफ़ अनुक्रमणिका कार्रवाई कतार पुनः आवंटित करें < परिनियोजन-आईडी> < आवंटन-आईडी> <allocationAmount>` - कतार पुनः आवंटित कार्रवाई
