...
Curators The Graph network को कुशल बनाते हैं और[signaling](#how-to-signal) यह वो प्रक्रिया है जिसे curators उसे index करने योग्य बताने के लिए Indexers को सूचित करने के लिए उपयोग करते हैं; जहां GRT एक subgraph के लिए bonding curve में जोड़ा जाता है। Indexers curator के signal से भरोसा कर सकते हैं क्योंकि signaling करने पर, curators उस subgraph के लिए एक curation share mint करते हैं, जिससे उन्हें future में उस subgraph द्वारा उत्पन्न किए गए query fees का एक हिस्सा प्राप्त होता है।
