...
जब श्रृंखला को संसाधित करते समय एक `स्थानांतरण` घटना का सामना करना पड़ता है, तो इसे उत्पन्न `स्थानांतरण` प्रकार (उपनाम <0 >TransferEvent</code> इकाई प्रकार के साथ नामकरण विरोध से बचने के लिए)। यह प्रकार ईवेंट के मूल लेन-देन और उसके पैरामीटर जैसे डेटा तक पहुँचने की अनुमति देता है।
...
ईवेंट हैंडलर्स को पास किए गए एथेरियम इवेंट्स, जैसे कि पिछले उदाहरणों में <कोड>ट्रांसफर</कोड> इवेंट, न केवल इवेंट पैरामीटर्स तक पहुंच प्रदान करते हैं, बल्कि उनके पैरेंट ट्रांजैक्शन और उस ब्लॉक तक भी पहुंच प्रदान करते हैं, जिसका वे हिस्सा हैं। निम्न डेटा <कोड>ईवेंट</कोड> उदाहरणों से प्राप्त किया जा सकता है (ये वर्ग <कोड>ग्राफ़-टीएस</कोड> में <कोड>एथेरियम</कोड> मॉड्यूल का एक हिस्सा हैं):
...
<कोड>ग्राफ़ कोडजेन</code> द्वारा जनरेट किए गए कोड में सबग्राफ़ में उपयोग किए जाने वाले स्मार्ट अनुबंधों की कक्षाएं भी शामिल होती हैं। इनका उपयोग सार्वजनिक राज्य चरों तक पहुँचने और वर्तमान ब्लॉक में अनुबंध के कार्यों को कॉल करने के लिए किया जा सकता है।
