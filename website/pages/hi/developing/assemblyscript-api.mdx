...
सबग्राफ़ मैनिफेस्ट में `apiVersion` एक API संस्करण को निर्दिष्ट करता है जिसका उपयोग ग्राफ नोड द्वारा एक निर्धारित सबग्राफ़ के लिए मैपिंग API संस्करण चलाने के लिए किया जाता है।
