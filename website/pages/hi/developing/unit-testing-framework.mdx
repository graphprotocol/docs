...
कृपया ध्यान दें, <0>आर्बिट्रम माइग्रेशन</0> पूरा होने पर इसमें सुधार होगा, जिससे नेटवर्क पर भाग लेने के लिए गैस की लागत काफी कम हो जाएगी।...
...
<कोड>संदर्भ()</कोड>, <कोड>पता()</कोड> और <कोड>नेटवर्क()</कोड> कार्यों के वापसी मान का मज़ाक उड़ाकर गतिशील डेटा स्रोतों का परीक्षण किया जा सकता है। डेटा स्रोत नाम स्थान। ये फ़ंक्शन वर्तमान में निम्नलिखित लौटाते हैं: `context()` - एक खाली इकाई (DataSourceContext), `address()` लौटाता है - `0x000000000000000000000000000000000000000`, ` देता है नेटवर्क () </ कोड> - <कोड> मेननेट </ कोड> लौटाता है। <code>create(...)` और `createWithContext(...)` फ़ंक्शंस को कुछ भी नहीं करने के लिए मज़ाक उड़ाया जाता है, इसलिए उन्हें परीक्षणों में बुलाए जाने की आवश्यकता नहीं है। `dataSourceMock` नेमस्पेस `matchstick-as` (संस्करण 0.3.0+) में दिए गए मानों में परिवर्तन किया जा सकता है।
