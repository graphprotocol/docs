...
एक बार subgraph बनाए जाने के बाद उसे हटाना संभव नहीं है। हालांकि, आप अपना subgraph [ट्रांसफर](/managing/transfer-a-subgraph/) और [डिप्रिकेट](/managing/deprecate-a-subgraph/) कर सकते हैं।
