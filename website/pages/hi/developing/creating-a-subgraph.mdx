...
यह विस्तृत मार्गदर्शिका 'subgraph' बनाने के लिए सफलतापूर्वक निर्देश प्रदान करती है।

एक subgraph ब्लॉकचेन से डेटा निकालता है, उसे प्रोसेस करता है, और उसे GraphQL के माध्यम से कुशलता से क्वेरी करने के लिए स्टोर करता है।
...
#### [npm](https://www.npmjs.com/) का उपयोग करते हुए
...
- <SUBGRAPH_SLUG> आपका subgraph का ID है [Subgraph Studio](https://thegraph.com/studio/) में। यह आपके subgraph विवरण पृष्ठ पर पाया जा सकता है।
...
- entitiesSubgraph इन इवेंट्स को हैंडल करता है द्वारा `Gravatar` एंटिटीज़ को Graph Node स्टोर में लिखकर और यह सुनिश्चित करता है कि ये इवेंट्स के अनुसार अपडेट होते रहें।
...
- `--merge-entities` विकल्प यह बताता है कि डेवलपर `entity` और `event` नाम के विरोधों को कैसे हैंडल करना चाहता है:
  ...
  - यदि ``false`\` हो: एक नया ``entity`\` और ``event`\` हैंडलर बनाया जाना चाहिए जिसका नाम ``${dataSourceName}{EventName}`\` होगा।
...
The subgraph manifest, `subgraph.yaml`, उन स्मार्ट कॉन्ट्रैक्ट्स और नेटवर्क को परिभाषित करता है जिन्हें आपका subgraph इंडेक्स करेगा, इन कॉन्ट्रैक्ट्स से ध्यान देने योग्य इवेंट्स को, और कैसे इवेंट डेटा को उन एंटिटीज़ में मैप करना है जिन्हें Graph Node स्टोर करता है और क्वेरी करने की अनुमति देता है।
...
- `mapping.ts`: [AssemblyScript Mappings](https://github.com/AssemblyScript/assemblyscript) कोड जो इवेंट डेटा को आपके स्कीमा में परिभाषित इकाइयों में अनुवाद करता है (जैसे कि इस गाइड में
...
- प्रत्येक अनुबंध के लिए जो अनुक्रमण की आवश्यकता होती है, `dataSources` ऐरे में एक प्रविष्टि जोड़ें।

सबग्राफ मैनिफेस्ट के लिए पूरी विशिष्टता [यहां](https://github.com/graphprotocol/graph-node/blob/master/docs/subgraph-manifest.md) मिल सकती है।

उदाहरण उपग्राफ के लिए, `subgraph.yaml` है:
...
> **आवश्यक**: [SpecVersion](#specversion-releases) >= `1.2.0`. वर्तमान में, `eth_calls` केवल इवेंट हैंडलरों के लिए घोषित किए जा सकते हैं।
...
### डिक्लेरिटिव `eth_calls` के बिना परिदृश्य -
...
### डिक्लेरटिव `eth_calls` के साथ परिदृश्य
...
### Subgraph Manifest उदाहरण कॉन्फ़िगरेशन
