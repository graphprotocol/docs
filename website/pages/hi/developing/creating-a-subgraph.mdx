...
#### डिक्लेरेटिव `eth_calls`के बिना परिदृश्य
...
#### डिक्लेरेटिव `eth_calls`के साथ  परिदृश्य
...
- यह पाठ (`Pool[event.address].feeGrowthGlobal0X128()`) वास्तविक `eth_call` है जिसे निष्पादित किया जाएगा, जो इस रूप में है `Contract[address].function(arguments)`
...
|  0.0.8  | पोलिंग के लिए समर्थन जोड़ा [ब्लॉक हैंडलर्स](/developing/creating-a-subgraph/#polling-filter) और [इनिशियलाइजेशन हैंडलर्स](/developing/creating-a-subgraph/#once-filter)। |
|  0.0.7  | फ़ाइल डेटा स्रोतों के लिए समर्थन जोड़ा गया [File Data Sources](/developing/creating-a-subgraph/#file-data-sources)।                                                     |
...
- यदि आप किसी सार्वजनिक प्रोजेक्ट के लिए subgraph बना रहे हैं, तो आप उस प्रोजेक्ट को अपने कंप्यूटर पर डाउनलोड कर सकते हैं और ABI प्राप्त कर सकते हैं, इसका उपयोग करके [`npx hardhat compile`](https://hardhat.org/hardhat-runner/docs/guides/compile-contracts#compiling-your-contracts) या `solc` का उपयोग करके कम्पाइल कर सकते हैं।
...
आपका 'subgraph' की 'schema' फाइल `schema.graphql` में है। 'GraphQL schemas' को 'GraphQL interface definition language' का उपयोग करके परिभाषित किया जाता है। यदि आपने कभी 'GraphQL schema' नहीं लिखा है, तो यह अनुशंसा की जाती है कि आप 'GraphQL type system' पर यह प्राइमर देखें। 'GraphQL schemas' के लिए संदर्भ दस्तावेज़ [GraphQL API](/querying/graphql-api/) अनुभाग में पाया जा सकता है।
