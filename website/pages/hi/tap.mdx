...
2. <recently-closed-allocation-buffer> अवधि, tap-agent सभी लंबित प्राप्तियों को उस विशेष आवंटन के लिए लेता है और एक RAV में समेकन के लिए अनुरोध करता है, इसे 'last' के रूप में चिह्नित करता है।
