...
3. (Ethereum only) जब curators अपने शेयर जलाकर GRT निकालते हैं, तो बची हुई शेयरों की GRT वैल्यूएशन घट जाएगी। ध्यान दें कि कुछ मामलों में, curators अपने शेयर एक बार में जला सकते हैं। यह स्थिति आम हो सकती है यदि कोई dapp डेवलपर अपने subgraph का वर्शनिंग/इंप्रूविंग और queries करना बंद कर देता है या यदि कोई subgraph फेल हो जाता है। नतीजतन, बचे हुए curators केवल अपने प्रारंभिक GRT का एक हिस्सा निकालने में सक्षम हो सकते हैं। एक कम जोखिम वाले नेटवर्क रोल के लिए, देखें [Delegators](/resources/roles/delegating/)।
