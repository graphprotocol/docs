...
Con el operador `o`, esta consulta filtrará las entidades de blog con variaciones de "anarquismo" o "crumpet" en sus campos de texto completo.
...
El operador `follow by` especifica palabras separadas por una distancia específica en los documentos de texto completo. La siguiente consulta devolverá todos los blogs con variaciones de "descentralizar" seguido por "filosofía"
...
Combina operadores de texto completo para crear filtros más complejos. Con un operador de búsqueda de pretexto combinado con una consulta de seguimiento de este ejemplo, se buscarán coincidencias con todas las entidades del blog con palabras que comiencen con "lou" seguido de "música".
