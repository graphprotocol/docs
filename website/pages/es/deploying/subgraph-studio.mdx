...
Recuerda que, mientras sigues los pasos de publicación, podrás publicar en la red principal (mainnet) o en Sepolia. Si eres un desarrollador de subgrafos por primera vez, te recomendamos encarecidamente que comiences publicando en Sepolia, lo cual es gratis. Esto te permitirá ver cómo funcionará el subgrafo en The Graph Explorer y te permitirá probar elementos de curación.
