...
Para obtener una lista completa de qué características son compatibles con la red descentralizada, consulte [esta página](https://github.com/graphprotocol/indexer/blob/main/docs/networks/mainnet.md#feature-support).
