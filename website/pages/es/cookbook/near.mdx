...
Si se trata de una pregunta general sobre el desarrollo de subgrafos, hay mucha más información en el resto de la [documentación para developers](/recetario/inicio rápido). De lo contrario, únase a [The Graph Protocol Discord](https://discord.gg/graphprotocol) y pregunte en el canal #near o envíe un correo electrónico a near@thegraph.com.
