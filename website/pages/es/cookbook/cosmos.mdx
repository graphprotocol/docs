...
La [blockchain de Cosmos Hub](https://hub.cosmos.network/) es la primera blockchain en el ecosistema

Cosmos</1 >. Puede visitar la [documentación oficial](https://docs.cosmos.network/) para obtener más información.</p> 
