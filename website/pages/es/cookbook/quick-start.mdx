...
Esta guía te mostrara como iniciar, crear y desplegar tu subgrafo en el subgrafo estudio o en el [servicio de alojamiento](#hosted-service).
...
- Bloque de inicio: se sugiere que ingreses el bloque de inicio para ahorrar tiempo mientras tu subgrafo indexa los datos de la cadena de bloques. Puedes ubicar el bloque de inicio encontrando el bloque en el que se implementó tu contrato.
