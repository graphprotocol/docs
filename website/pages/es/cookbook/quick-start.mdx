...
Selecciona la red en la que deseas publicar tu subgrafo. Se recomienda publicar subgrafos en Arbitrum One para aprovechar las [velocidades de transacción más rápidas y los costos de gas más bajos](/arbitrum/arbitrum-faq).
