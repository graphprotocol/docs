---
title: Категоризация маркетплейсов NFT с использованием Enum (перечислений)
---

Используйте перечисления (Enums), чтобы сделать Ваш код чище и уменьшить вероятность ошибок. Вот полный пример использования перечислений для маркетплейсов NFT.
