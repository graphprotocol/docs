...
| Network | Announcing integration on The Graph Network | Network Integration complete | Этап 1: отключение новых субграфов в хостинговом сервисе | Этап 2: отключение обновления субграфов в хостинговом сервисе | Этап 3: отключение субграфов в хостинговом сервисе |
| --- | :-: | :-: | :-: | :-: | :-: |
| Ethereum | ✓ | ✓ |  |  |  |
| Gnosis (ранее xDAI) | ✓ | ✓\* |  |  |  |
| Polygon | ✓ |  |  |  |  |
