...
[Пример фильтрации блоков](https://github.com/graphprotocol/example-subgraphs/tree/main/cosmos/block-filtering)

[Пример вознаграждения валидатора](https://github.com/graphprotocol/example-subgraphs/tree/main/cosmos/validator-rewards)

[Пример делегирования валидатора](https://github.com/graphprotocol/example-subgraphs/tree/main/cosmos/validator-delegations)

[Пример свопа токенов Osmosis](https://github.com/graphprotocol/example-subgraphs/tree/main/cosmos/osmosis-token-swaps)
