...
- **Manifeste de subgraph** : fichier JSON qui décrit le schéma GraphQL, les sources de données et d'autres métadonnées du subgraph. [Voici](https://ipfs.io/ipfs/QmVQdzeGdPUiLiACeqXRpKAYpyj8Z1yfWLMUq7A7WundUf) un exemple.

- **Epoch**: A unit of time within the network. Currently, one epoch is 6,646 blocks or approximately 1 day.

- **Allocation** : Un indexeur peut allouer sa mise totale GRT (y compris la mise des délégués) vers des subgraphs qui ont été publiés sur le réseau décentralisé de The Graph. Les allocations se déroulent en quatre phases.
