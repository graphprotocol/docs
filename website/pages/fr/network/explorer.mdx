...
- Réduction des frais de requête - le % des frais de requête que l'Indexeur conserve lors de la répartition avec les Délégateurs.
- Réduction efficace des récompenses - la réduction des récompenses d'indexation appliquée au pool de délégation. Si elle est négative, cela signifie que l'Indexeur donne une partie de ses récompenses. Si elle est positive, cela signifie que l'Indexeur garde une partie de ses récompenses.
...
- Frais de requête - il s'agit du total des frais que les utilisateurs finaux ont payés pour les requêtes d'un Indexeur au fil du temps.
