...
C'est ça! Vos subgraphs seront déployés sur Subgraph Studio et publiés sur le réseau The Graph. Vous pouvez accéder au [Subgraph Studio] (thegraph.com/studio) pour gérer vos subgraphs, en vous connectant avec le portefeuille spécifié lors du processus de mise à niveau.
