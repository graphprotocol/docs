---
title: Générateur de code de subgraphe sécurisé
---
...
- **Disponibilité continue**. Les entités mal gérées peuvent provoquer le crash des subgraphes, ce qui peut perturber les projets qui dépendent de The Graph. Configurez des fonctions d'assistance pour rendre vos subgraphes "incassables" et assurer la continuité des activités.
