...
Dans ce guide, vous apprendrez à construire et à déployer de nouveaux subgraphs en utilisant le graffage sur des subgraphs existants.
...
les sources de données:
   - genre : ethereum
     ...
     réseau : goerli
     source:
       adresse : '0x4Ed995e775D3629b0566D2279f058729Ae6EA493'
       abi : Verrouiller
       bloc de démarrage : 7674603
     cartographie :
       ...
       abis :
         - nom : Serrure
           fichier : ./abis/Lock.json
       Gestionnaires d'événements :
         - événement : Retrait (uint256,uint256)
           gestionnaire : handleRetrait
       fichier : ./src/lock.ts
```
