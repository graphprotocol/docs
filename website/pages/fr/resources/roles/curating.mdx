...
3. (Sur Ethereum uniquement) Lorsque les curateurs brûlent leurs parts pour retirer leurs GRT, la valeur en GRT des parts restantes est réduite. Sachez que, dans certains cas, les curateurs peuvent décider de brûler leurs parts en une seule fois. Cette situation peut se produire si un développeur de dapp cesse de versionner/de faire évoluer et d'interroger son subgraph, ou si un subgraph échoue. Par conséquent, les curateurs restants pourraient ne récupérer qu’une partie de leur GRT initial. Pour un rôle réseau avec un profil de risque plus faible, regardez la section sur les [Délégateurs](/resources/roles/delegating/).
