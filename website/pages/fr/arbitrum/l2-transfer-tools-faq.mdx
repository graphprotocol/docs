...
Si vous avez misé ou délégué tous vos TRG à partir du contrat de vesting, vous pouvez envoyer manuellement un petit montant comme 1 TRG à l'adresse du contrat de vesting à partir de n'importe quel autre endroit ( par exemple, à partir d'un autre portefeuille ou d'un échange )
