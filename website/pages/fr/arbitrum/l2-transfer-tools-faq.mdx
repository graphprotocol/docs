...
Pour transférer votre délégation, vous devrez compléter les étapes suivantes :

1.  Lancer un transfert de délégation sur le mainnet Ethereum
2.  Attendre 20 minutes pour la confirmation
3.  Confirmation du transfert de délégation sur Arbitrum
...
### Que va-t-il se passer si l’indexeur auquel je délègue actuellement mes pouvoirs n’est pas dans Arbitrum un?
