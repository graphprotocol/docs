...
**Sunbeam**: The 60 day upgrade window that subgraph developers will have to upgrade their subgraphs to The Graph Network. The window opens on April 11th and closes on June 10th. **Sunrise**: Hosted service endpoints will expire as traffic moves to The Graph Network.
...
The Upgrade Window starts on April 11th and ends on June 10th.

### What happens if I don't upgrade my subgraph?

After June 10th, hosted service endpoints will expire and all queries will be served by The Graph Network.
...
You can use the [Subgraph Studio](https://thegraph.com/studio/) to create, test, and publish your subgraph. All hosted service users must upgrade their subgraph to The Graph Network before the end of the 60 day upgrade window ending on June 10th.
