...
Hosted service query endpoints will remain active until 10 a.m. PT on June 12th, regardless of whether they have been upgraded. After June 12th at 10 a.m. PT, query endpoints will no longer be available, and developers will no longer be able to deploy new subgraph versions.
