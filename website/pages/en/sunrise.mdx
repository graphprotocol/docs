...
**Sunbeam**: The 60 day upgrade window that subgraph developers will have to upgrade their subgraphs to The Graph Network. This window will end on END-DATE-PLACEHOLDER.  
**Sunrise**: Hosted service endpoints will be deprecated on END-DATE-PLACEHOLDER.

## Upgrading subgraphs to The Graph Network

### When will hosted service subgraphs no longer be available?

Hosted service subgraph endpoints will be rate limited on END-DATE-PLACEHOLDER, 2024 (the cutoff date).
...
You can use the [Subgraph Studio](https://thegraph.com/studio/) to create, test, and publish your subgraph. All hosted service users must upgrade their subgraph to The Graph Network before the end of the 60 day upgrade window ending on END-DATE-PLACEHOLDER.
