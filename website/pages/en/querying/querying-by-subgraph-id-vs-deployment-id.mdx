...
The Subgraph ID is a unique identifier for a subgraph. It remains constant across all versions of a subgraph. When queries are made using the Subgraph ID, you are not specifying a version. This means that the version of the subgraph that responds to your query may not be the latest version.

When you query using a Subgraph ID, The Graph will route your query to the latest synced and healthy version of the subgraph. This means that the version of the subgraph that responds to your query may not be the latest version, but it will be the most recent version that is synced and healthy.
...
If you want to ensure that the latest version of your subgraph always responds to your queries, you should use the Deployment ID. This requires you to update the Deployment ID in your front-end whenever you publish a new version of your subgraph.
