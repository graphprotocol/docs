...
Subgrounds is an intuitive Python library for querying subgraphs, built by [Playgrounds Analytics](https://playgrounds.network). It allows you to directly connect subgraph data to a Python data environment, letting you use libraries like [pandas](https://pandas.pydata.org/) to perform data analysis!
