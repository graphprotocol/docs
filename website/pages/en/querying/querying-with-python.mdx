...
Subgrounds is an intuitive Python library for querying subgraphs, build by [Playgrounds Analytics](https://playgrounds.network). It allows you to directly connect subgraph data to a Python data environment, letting you use libraries like [pandas](https://pandas.pydata.org/) to perform data analysis!
...
Subgrounds is built and maintained the [Playgrounds](https://playgrounds.network) team and can be accessed on the [Playgrounds docs](https://docs.playgrounds.network/subgrounds).
