...
Visit [substreams.dev](https://substreams.dev/) to explore a growing collection of ready-to-use Substreams packages across various blockchain networks.
...
<figure><img src="./assets/publish-package/1_get-token.png" alt="" width="100%"></figure>
...
<figure><img src="./assets/publish-package/2_new_token.png" alt="" width="100%"></figure>

## Step 3: Authenticate in the Substreams CLI

1. Back in the Substreams CLI, paste the previously generated token.

<figure><img src="./assets/publish-package/3_paste_token.png" alt="" width="100%"></figure>

2. Lastly, confirm that you want to publish the package.

<figure><img src="./assets/publish-package/4_confirm.png" alt="" width="100%"></figure>
