...
On the Arbitrum deployment curating subgraphs becomes significantly more advantageous. The bonding curves are "flattened", their effect is nullified meaning no curator will be able to realize gains at the expense of others. This allows Curators to signal or unsignal on subgraphs at any given time, at a consistent cost with very limited risk.
