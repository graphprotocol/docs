...
| Network | Guides | System Requirements | Indexing Rewards | Additional Info |
| --- | --- | --- | :-: | --- |
...
| Starknet | [Firehose Docker Guide](https://docs.infradao.com/archive-nodes-101/starknet/firehose/docker) | 4+ core CPU<br /> Ubuntu 22.04<br /> 16GB+ RAM<br /> >= 1 TiB NVMe SSD<br /> _last updated August 2023_ | ✅ |  |
