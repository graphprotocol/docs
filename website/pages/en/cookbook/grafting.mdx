...
Building subgraphs is an essential part of The Graph, described more in depth [here](/cookbook/quick-start/). To be able to build and deploy the existing subgraph used in this tutorial, the following repo is provided:
...
- `features:` is a list of all used [feature names](https://thegraph.com/docs/en/developing/creating-a-subgraph/#experimental-features).
