...
> **Caution**: if you are upgrading your subgraph from Subgraph Studio to the decentralized network, it is strongly recommended to avoid using grafting during the upgrade process.
