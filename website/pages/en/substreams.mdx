...
To learn about latest version of Substreams CLI, which enables developers to bootstrap a Substream project without any code, please check [Substreams Codegen](https://streamingfastio.medium.com/substreams-codegen-no-code-tool-to-bootstrap-your-project-a11efe0378c6).
