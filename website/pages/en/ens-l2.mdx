...
> Note: this tutorial assumes the ENS name is owned by the multi-sig wallet.

## Step 1: Create New ENS Subnames

- Access the **Safe Global online dapp**.
...
## Step 6: Co-signer Transaction Signing

- If your multisig wallet owns the main domain, your co-signers will need to sign the transactions to meet the required threshold for your organization’s account.

## Step 7: Add Subnames to Arbitrum Wallet
