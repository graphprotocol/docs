...
The subscription billing model allows you to pay a fixed monthly fee for a fixed number of queries. This model is currently in beta, and is only available to a limited number of data consumers. The subscriptions model allows you to pay for queries using USDC on Arbitrum. USDC is added to the the [subscriptions contract](), and used to pay for queries associated with your query keys.
