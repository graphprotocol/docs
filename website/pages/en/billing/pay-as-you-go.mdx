...
In addition to [subscriptions](./subscriptions), The Graph offer a pay as you go model that allows you to prepay query fees with GRT. Pay as you go invoices are generated on a weekly basis. To pay for queries using the pay as you go model, there are two options to pay for your query fees:
