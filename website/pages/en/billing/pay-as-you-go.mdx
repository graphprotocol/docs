...
In addition to [The Graph's Subscriptions model](./subscriptions), The Graph also offers a pay as you go model that allows you to deposit GRT to cover query fees on The Graph Network. With the pay as you go model, there are two options to pay for your query fees:
...
While The Graph protocol operates on Ethereum Mainnet and Arbitrum One, [the billing contract](https://arbiscan.io/address/0x1b07d3344188908fb6deceac381f3ee63c48477a) lives entirely on [Arbitrum](https://arbitrum.io/) to reduce transaction times and cost. You'll be required to pay the query fees generated from your API keys. These invoices will be generated once a week. Using the billing contract, you'll be able to:
