...
Historically, data consumers on The Graph have used the pay as you go billing model to pay for query fees. This model allows you to pay for queries using GRT. The GRT is added to your account balance on the [billing contract](https://arbiscan.io/address/0x1b07d3344188908fb6deceac381f3ee63c48477a), and used to pay for queries associated with your API keys. Core dev teams have added functionality to support subscriptions, which you can learn about [here](./subscriptions-billing).

To pay for queries using the pay as you go model, there are two options to pay for your query fees:
