...
> Please note, hosted service endpoints will expire on END-DATE-PLACEHOLDER as all subgraphs will need to upgrade to The Graph Network. Please read more in the [Sunrise FAQ](/sunrise)
