...
2. **Indexer Service**
   ...
   - Fully replace your current configuration with the [new Indexer Service rs](https://github.com/graphprotocol/indexer-rs). We recommend that you use the 
...
3. **TAP Agent**
   ...
   - Run *one* single instance of [TAP Agent](https://github.com/graphprotocol/indexer-rs) at all times. We recommend that you use the 
     [container image](https://github.com/orgs/graphprotocol/packages?repo_name=indexer-rs).
