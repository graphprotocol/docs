...
- `specVersion`: a semver version indicating which version of this API is being used. See [specVersion releases](#specversion-releases) section to see more details on features & releases.
