...
> **Note:** it is not recommended to use grafting when initially upgrading to The Graph Network. For more information, learn more [here](/cookbook/grafting/#important-note-on-grafting-when-upgrading-to-the-network).
