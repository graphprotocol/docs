...
- If a subgraph was published via the CLI and picked up by an Indexer, it could technically be queried even without support. However, please note that efforts are currently underway to improve integration for Indexers and consumers across the board.  
