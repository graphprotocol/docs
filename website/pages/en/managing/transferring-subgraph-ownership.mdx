...
Easily transfer your subgraph ownership. Subgraphs published to the decentralized network have an NFT minted to the address that published the subgraph. The NFT is based on a standard ERC721, which facilitates transfers between accounts on The Graph Network.
...
1.  Use the UI built into Subgraph Studio: ![Subgraph Ownership Transfer](/img/subgraph-ownership-transfer-1.png)

2.  Choose the address that you would like to transfer the subgraph to: ![Subgraph Ownership Trasfer](/img/subgraph-ownership-transfer-2.png)

Optional: You can also use the built-in UI of NFT marketplaces like OpenSea:
...
3.  Now, your subgraph will not appear in searches on Graph Explorer.
