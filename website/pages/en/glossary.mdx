...
- **Pay as you go**: A pricing model for data consumers that allows them to pay for query fees as they go using either GRT or a credit card with Banxa.

- **Subscription billing**: A pricing model for data consumers that allows them to pay for query fees on a monthly basis using USDC on Arbitrum One.
