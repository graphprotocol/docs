...
- **L2 Transfer Tools**: Smart contracts and UI that enables network participants to transfer network related assets from Ethereum mainnet to Arbitrum One. Network participants can transfer delegated GRT, subgraphs, curation shares, and Indexer's self stake.
...
- **Migrating**: The process of curation shares moving from an old version of a subgraph to a new version of a subgraph (i.e., when v0.0.1 is updated to v0.0.2).
