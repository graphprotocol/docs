...
- **L2 Transfer Tools**: Smart contracts and UI that enable network participants to transfer to Arbitrum One. Network participants can transfer delegated GRT, subgraphs, curation shares, and Indexer's self stake.
