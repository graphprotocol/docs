...
Simply type `graph publish` after doing `graph build && graph codegen` and a window will open up allowing you to connect your wallet, add metadata, and deploy your finalized subgraph to a network of your choice.
