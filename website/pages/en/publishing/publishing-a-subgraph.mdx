...
2. Use the following commands: `graph publish` then `graph build && graph codegen`
...
```
USAGE
  $ graph publish [SUBGRAPH-MANIFEST] [-h] [-i <value>] [--ipfs-hash <value>] [--webapp-url <value>] [--subgraph-id <value>] [--protocol-name <value>]
...
FLAGS
  ...
  --subgraph-id=<value>     ID of the subgraph to update.
  --protocol-name=<value>   Name of the protocol for the subgraph update.
...
Learn more about [Curating](https://thegraph.com/docs/en/network/curating/) on The Graph Network.
