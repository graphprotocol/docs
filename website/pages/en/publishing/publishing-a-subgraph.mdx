...
- Subgraphs can be published to Arbitrum One, or Arbitrum Sepolia (testnet with no guarantee of indexing support). [Learn more about The Graph Network on Arbitrum](/arbitrum/arbitrum-faq).
...
> If your subgraph is eligible for rewards, is recommended that you curate your own subgraph with at least 3,000 GRT in order to attract additional indexers to index your subgraph

Subgraph Studio enables you to be the first to add signal to your subgraph by adding GRT to your subgraph's curation pool in the same transaction. When publishing your subgraph, make sure to check the button that says, "Be the first to signal on this subgraph."
