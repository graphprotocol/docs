...
## Query Payments with Stripe

- To set up billing with Stripe, users will access Subgraph Studio (https://thegraph.com/studio/)
    ...
    4. To choose a credit card payment, choose “Credit card” as the payment method and fill out your credit card information. Those who have used Stripe before can use Link to autofill their details. 
- Stripe invoices will be processed at the end of each month and require an active credit card on file for all queries beyond the free plan quota.
