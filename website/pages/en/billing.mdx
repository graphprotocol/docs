...
### What happens when GRT is depleted? Will I get a warning?

Users will receive an email when GRT is close to depletion. You will receive several notifications before billing runs out.

### Which chain does GRT need to be on?

Albitrum is the best option, but users can bridge their GRT and ETH using any of the following options:
