...
- **Free Plan**: The Free Plan includes 100,000 free monthly queries with full access to Subgraph Studio testing environment. This plan is designed for hobbyists, hackathoners, and those with side projects to try out The Graph before scaling their dapp.
