...
You can find the L2 Transfer Tool when you're looking at your subgraph's page on Subgraph Studio: ![Dropdown switcher to toggle Arbitrum](/img/l2-transfer-tools-subgraph-studio.png)

[ screenshot showing the "Transfer to L2" button on Studio]
...
[ screenshot showing the "Transfer to L2" button on Explorer]
...
[Screenshot showing the subgraph page]
