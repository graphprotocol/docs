...
It is really a matter of where you put your logic, in the subgraph or the Substreams. Keep in mind that having your logic in Substreams benefits from a parallelized model, whereas Substreams triggers will be linearly consumed. Consider the following example using a subgraph handler:
