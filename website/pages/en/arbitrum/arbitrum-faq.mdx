...
## Billing on Arbitrum with the Pay as you go model FAQs
...
Adding GRT to your Arbitrum billing balance can be done with a seamless experience in [Subgraph Studio](https://thegraph.com/studio/). You'll be able to easily bridge your GRT to Arbitrum and fill your API keys in one transaction.

Visit the [pay as you go billing page](../billing/pay-as-you-go) for more detailed instructions on adding, withdrawing, or acquiring GRT.
