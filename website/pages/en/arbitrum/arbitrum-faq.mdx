...
To pay for queries, you must bridge your GRT to Arbitrum. You can do this via the GRT bridging option provided in Subgraph Studio or by using one of the following bridges:
...
- If you already have assets on Arbitrum, then acquire GRT via a swapping protocol like Uniswap.

- If you acquire GRT directly on Arbitrum, then make sure you use a decentralized exchange on Arbitrum.
