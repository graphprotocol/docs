...
- **Ethereum नोड** - डीफॉल्टनुसार, डॉकर कंपोझ सेटअप मेननेट वापरेल: [http:// host.docker.internal:8545](http://host.docker.internal:8545) तुमच्या होस्ट मशीनवरील इथरियम नोडशी कनेक्ट करण्यासाठी. तुम्ही `docker-compose.yml` अपडेट करून हे नेटवर्क नाव आणि url बदलू शकता.
...
2. फक्त लिनक्स वापरकर्त्यांसाठी - समाविष्ट स्क्रिप्ट वापरून `docker-compose.yml` मध्ये `host.docker.internal` ऐवजी होस्ट IP पत्ता वापरा:
