...
`graph-cli 0.25.2` वरून, `ग्राफ चाचणी` कमांड `-d</0 सह डॉकर कंटेनरमध्ये <code>मॅचस्टिक` चालवण्यास समर्थन देते > ध्वज. डॉकर अंमलबजावणी [बाइंड माउंट](https://docs.docker.com/storage/bind-mounts/) वापरते त्यामुळे प्रत्येक वेळी `ग्राफ चाचणी -d` कमांड कार्यान्वित केल्यावर डॉकर प्रतिमा पुन्हा तयार करावी लागत नाही. वैकल्पिकरित्या तुम्ही डॉकर मॅन्युअली चालवण्यासाठी [मॅचस्टिक](https://github.com/LimeChain/matchstick#docker-) रेपॉजिटरीमधील सूचना फॉलो करू शकता.
...
**मॅचस्टिक** वापरून, सबग्राफ डेव्हलपर एक स्क्रिप्ट चालवण्यास सक्षम आहेत जी लिखित युनिट चाचण्यांच्या चाचणी कव्हरेजची गणना करेल. टूल फक्त **Linux** आणि **MacOS** वर कार्य करते, परंतु जेव्हा आम्ही डॉकरसाठी समर्थन जोडतो (त्यावरील प्रगती [येथे](https://github.com/LimeChain/matchstick/issues/222) पहा) वापरकर्ते वापरण्यास सक्षम असावेत. ते कोणत्याही मशीनवर आणि जवळजवळ कोणत्याही OS वर.

चाचणी कव्हरेज साधन खरोखर सोपे आहे - ते संकलित चाचणी `wasm` बायनरी घेते आणि त्यांना `wat` फाइल्समध्ये रूपांतरित करते, जे नंतर हँडलर परिभाषित केले आहे की नाही हे पाहण्यासाठी सहजपणे तपासले जाऊ शकते. `subgraph.yaml` मध्ये प्रत्यक्षात कॉल केला आहे. कोड कव्हरेज (आणि संपूर्ण चाचणी) असेंबलीस्क्रिप्ट आणि WebAssembly मध्ये अगदी सुरुवातीच्या टप्प्यात असल्याने, **Matchstick** शाखा कव्हरेज तपासू शकत नाही. त्याऐवजी, दिलेल्या हँडलरला कॉल केल्यास, त्याच्यासाठी इव्हेंट/फंक्शनची योग्य प्रकारे खिल्ली उडवली गेली आहे, या प्रतिपादनावर आम्ही अवलंबून आहोत.
...
आशा आहे की ते कोणत्याही समस्यांशिवाय कव्हरेज साधन कार्यान्वित केले पाहिजे. टर्मिनलमध्ये तुम्हाला असे काहीतरी दिसले पाहिजे:
