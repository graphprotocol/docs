...
विकेंद्रीकृत नेटवर्कवर कोणती वैशिष्ट्ये समर्थित आहेत या संपूर्ण सूचीसाठी, [हे पहा पृष्ठ](https://github.com/graphprotocol/indexer/blob/main/docs/networks/mainnet.md#feature-support).
