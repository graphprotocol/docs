...
'@/src/getSupportedNetworks' वरून { getSupportedNetworks } आयात करा

<Table>
  <tr>
    <th>नेटवर्क्स</th>
    <th>CLI नाव</th>
    <th align="center">साखळी ID</th>
    <th align="center">होस्ट केलेली सेवा</th>
    <th align="center">सबग्राफ स्टुडिओ</th>
    <th align="center">विकेंद्रित नेटवर्क</th>
...
विकेंद्रीकृत नेटवर्कवर कोणती वैशिष्ट्ये समर्थित आहेत या संपूर्ण सूचीसाठी, [हे पृष्ठ](https://github.com/graphprotocol/indexer/blob/main/docs/feature-support-matrix.md) पहा.

सबस्ट्रिम्स-पॉवर्ड सबग्राफ्सची `मेननेट` ईथेरियम सबग्राफ्स सबग्राफ स्टूडियो आणि डिसेंट्रलाइझ्ड नेटवर्कवर समर्थित आहेत.

## आलेख नोड

आपल्या पसंतीच्या नेटवर्कला The Graph च्या डिसेंट्रलाइझ्ड नेटवर्कवर समर्थित नसल्यास, आपल्याला कोणत्याही EVM-संगत नेटवर्कला सूचीबद्ध करण्यासाठी आपल्या स्वत:च्या [Graph Node](https://github.com/graphprotocol/graph-node) चालवायला संधी आहे. आपल्याला किंमती आवश्यक आहेत की आपल्याला वापरत आहात, आणि तुमच्याकडून आवश्यक कॉन्फिगरेशन आहे, हे सुनिश्चित करा. [येथे](https://github.com/graphprotocol/graph-node/releases) जा कि आपल्याला किंमती समर्थन आहे.
