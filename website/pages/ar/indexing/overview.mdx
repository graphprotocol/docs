...
| المنفذ | Purpose                | المسار | CLI Argument               | Environment Variable                    |
| ------ | ---------------------- | ------ | -------------------------- | --------------------------------------- |
...
<strong x-id="1">ملاحظة</strong>: بعد بدء ال containers ، يجب أن تكون خدمة المفهرس متاحة على <a href="http://localhost:7600">http://localhost:7600</a> ويجب على وكيل المفهرس عرض API إدارة المفهرس على <a href="http://localhost:18000/">http://localhost:18000/</a>.
