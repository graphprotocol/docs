...
## 2.  قم بتثبيت واجهة سطر الأوامر للغراف (Graph CLI)

The Graph CLI is written in JavaScript and you will need to have either `npm` or `yarn` installed to use it.

على جهازك المحلي، قم بتنفيذ أحد الأوامر التالية:

باستخدام[npm](https://www.npmjs.com/):

```sh
npm install -g @graphprotocol/graph-cli
```

باستخدام [yarn] \(https://yarnpkg.com/):
