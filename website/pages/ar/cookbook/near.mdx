---
title: بناء الفرعيةرسم بياني على NEAR
---

> يتوفر دعم NEAR في عقدة الرسم البياني وفي الخدمة المستضافة في مرحلة تجريبية: يرجى التواصل مع near@thegraph.com إذا كانت لديك أي أسئلة حول إنشاء NEAR الفرعية رسم بياني!
...
يتم تمرير هذه الأنواع لمعالجات الكتلة و الاستلام:
