...
لا تتردد في الاستفادة من [ قناة Curators# ](https://discord.gg/graphprotocol) على Discord لإعلام المنسقين (Curators) بأن الـ subgraph الخاص بك جاهز للإشارة إليه. وسيكون من المفيد أيضا أن تشارك حجم الاستعلام المتوقع معهم. بالتالي، يمكنهم تقدير مقدار GRT الذي يجب أن يشيروا إليه في الـ subgraph الخاص بك.
