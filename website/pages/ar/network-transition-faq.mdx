...
تعتبر الشبكة اللامركزية لـ Graph أقل تكلفة بنسبة 60-90٪ من تشغيل البنية التحتية المخصصة ، كما هو موضح في [دراسات هذه الحالات](https://thegraph.com/docs/en/network/benefits/#low-volume-user-less-than-30-000-queries-per-month).
