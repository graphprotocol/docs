...
## إنشاء الفرعية رسم بياني على الخدمة المستضافة

قبل نشر الـ الفرعيةرسم بياني ، تحتاج إلى إنشائه في مستكشف الرسم البياني. انتقل إلى [لوحة القيادة](https://thegraph.com/hosted-service/dashboard) وانقر على _'يضيف الفرعيةرسم بياني'_ واملأ المعلومات أدناه حسب الحاجة:

**صورة** - اختر صورة لاستخدامها كصورة عرض وصورة مصغرة للـ الفرعيةرسم بياني.

**الفرعيةرسم بياني اسم** - بالاضافة لاسم الحساب الذي تم إنشاء الـ الفرعيةرسم بياني ضمنه، سيؤدي هذا أيضا إلى تعريف اسم النمط `account-name/subgraph-name` - المستخدم لعمليات النشر و GraphQL endpoints. _لا يمكن تغيير هذا الحقل لاحقا._

**حساب** - الحساب الذي تم إنشاء الـ الفرعيةرسم بياني ضمنه. يمكن أن يكون هذا حساب فرد أو منظمة. _لا يمكن نقل الـ الفرعيةرسم بياني بين الحسابات لاحقا._

**العنوان الفرعي** - النص الذي سيظهر في بطاقات الـ الفرعيةرسم بياني.

**وصف** - وصف الـ الفرعيةرسم بياني ، ويكون مرئيا في صفحة تفاصيل الـ الفرعيةرسم بياني.

** جيثب رابط** - رابط لمستودع الـ الفرعيةرسم بياني على جيثب.

**يخفي** - يؤدي تشغيل هذا إلى إخفاء الـ الفرعيةرسم بياني في مستكشف الرسم البياني.
...
## نشر الفرعيةرسم بياني على الخدمة المستضافة

سيؤدي نشر الـ الفرعيةرسم بياني الخاص بك إلى رفع ملفاته والتي قمت بإنشائها باستخدام `yarn build` إلى IPFS وإخبار مستكشف الرسم البياني ببدء فهرسة الـ الفرعيةرسم بياني باستخدام هذه الملفات.

يمكنك نشر الـ الفرعيةرسم بياني عن طريق تنفيذ `yarn deploy`
...
## إعادة نشر الـ الفرعيةرسم بياني
