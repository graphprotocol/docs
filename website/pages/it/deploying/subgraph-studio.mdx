...
Ricordate che, durante il flusso di pubblicazione, sarete in grado di effettuare il push su mainnet o su Goerli. Se siete alle prime armi con lo sviluppo di un subgraph, vi suggeriamo di iniziare con la pubblicazione su Goerli, che è gratuita. Questo vi permetterà di vedere come funzionerà il subgraph nel The Graph Explorer e di testare gli elementi di curation.
