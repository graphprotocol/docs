...
The Graph ha reso la partecipazione alla rete 26 volte meno costosa implementando il protocollo su Arbitrum One. Gli Strumenti di Trasferimento L2 sono stati creati dai core developer per facilitare il passaggio a L2. Per ogni partecipante al protocollo, verrà condiviso un set di strumenti di trasferimento per rendere l'esperienza senza interruzioni durante il passaggio a L2, evitando periodi di sblocco o il bisogno di prelevare manualmente e trasferire GRT. Questi strumenti richiederanno di seguire una serie specifica di passaggi a seconda del ruolo dell'utente all'interno di The Graph e di ciò che si sta trasferendo su L2.
...
\*Tieni in conto che devi confermare il trasferimento entro 7 giorni, altrimenti il tuo subgraph potrebbe andare perso. Nella maggior parte dei casi, questo passaggio verrà eseguito automaticamente, ma potrebbe essere necessaria una conferma manuale se c'è un aumento deil prezzo del gas su Arbitrum. Se ci sono problemi durante questo processo, ci saranno risorse disponibili per aiutarti: contatta l'assistenza all'indirizzo support@thegraph.com o su [Discord](https://discord.gg/vtvv7FP).

## Da dove devo inizializzare il mio trasferimento?

Puoi inizializzare il tuo trasferimento da [Subgraph Studio](https://thegraph.com/studio/), [Explorer,](https://thegraph.com/explorer) o dalla pagina di dettaglio di qualsiasi subgraph. Clicca sul bottone "Trasferisci Subgraph" sulla pagina di dettaglio del subgraph e inizia il trasferimento.

## Quanto devo aspettare per il completamento del trasferimento del mio subgraph
...
## I miei subgraph saranno ancora rintracciabili dopo averli trasferiti su L2?
...
## Il mio subgraph deve essere pubblicato per poterlo trasferire?
...
## Cosa succede alla versione del mio subgraph sulla mainnet di Ethereum dopo il trasferimento su Arbitrum?
...
## Dopo il trasferimento, devo anche pubblicare di nuovo su Arbitrum?
