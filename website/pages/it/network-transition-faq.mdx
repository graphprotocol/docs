...
| La rete                | Announcing integration on The Graph Network | Network Integration complete | Phase 1: disable new subgraphs on hosted service | Phase 2: disable subgraph updates on hosted service | Phase 3: disable subgraphs on hosted service |
| ---------------------- |:-------------------------------------------:|:----------------------------:|:------------------------------------------------:|:---------------------------------------------------:|:--------------------------------------------:|
| Ethereum               |                      ✓                      |              ✓               |                                                  |                                                     |                                              |
