...
To work on queries that have been flagged as having validation errors, you can use your favorite GraphQL query tool, like Altair or <https://graphiql-online.com/graphiql>, and try your query out. Those tools will also mark those errors in their UI, even before you run it.
