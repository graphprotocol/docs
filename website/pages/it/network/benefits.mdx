...
- Accesso a 438 Indexer (e in aumento)
...
La rete decentralizzata di The Graph consente agli utenti di accedere a una ridondanza geografica che non esiste quando si ospita un `graph-node`. Le query sono servite in modo affidabile grazie a un uptime superiore al 99,9%, ottenuto grazie a 168 indicizzatori (e in aumento) che proteggono la rete a livello globale.
