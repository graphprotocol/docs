...
انعامات کا حساب لگانے کے لیے کمیونٹی کی طرف سے متعدد ٹولز بنائے گئے ہیں; آپ کو ان کا ایک مجموعہ [کمیونٹی گائیڈز کا مجموعہ](https://www.notion.so/Community-Guides-abbb10f4dba040d5ba81648ca093e70c) میں مل جائے گا. آپ [ڈسکارڈ سرور](https://discord.gg/graphprotocol) پر Delegators# اور Indexers# چینلز میں ٹولز کی تازہ ترین فہرست بھی تلاش کر سکتے ہیں. یہاں ہم ایک [تجویز کردہ ایلوکیشن آپٹیمائزر](https://github.com/graphprotocol/AllocationOpt.jl) کو مربوط کرتے ہیں جو کہ انڈیکسر سافٹ ویئر اسٹیک کے ساتھ مرکوب ہے.
