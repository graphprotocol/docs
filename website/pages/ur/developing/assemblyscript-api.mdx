...
`address` ایتھیریم `Address` اقدار کی نمائندگی کرنے کے لیے `Bytes` کو بڑھاتا ہے.
...
تیار کردہ کلاسوں کے ساتھ، ایتھیریم کی اقسام اور [بلٹ ان اقسام](#built-in-types) کے درمیان تبدیلیاں پردے کے پیچھے ہوتی ہیں تاکہ سب گراف مصنفین کو ان کے بارے میں فکر کرنے کی ضرورت نہ ہو.
...
`graph codegen` کے ذریعے تیار کردہ کوڈ میں سب گراف میں استعمال ہونے والے سمارٹ کنٹریکٹس کی کلاسز بھی شامل ہیں۔ یہ موجودہ بلاک میں عوامی ریاست کے متغیرات اور کنٹریکٹ کے کال فنکشنز تک رسائی حاصل کرنے کے لیے استعمال کیے جا سکتے ہیں.
