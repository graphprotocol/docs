...
Arweave کے لیے، گراف نوڈ Arweave گیٹ وے سے ان کی [ٹرانزیکشن آئی ڈی](https://docs.arweave.org/developers/server/http-api#transactions) کی بنیاد پر فائلیں بازیافت کرنے کے قابل ہے۔([example file](https://bdxujjl5ev5eerd5ouhhs6o4kjrs4g6hqstzlci5pf6vhxezkgaa.arweave.net/CO9EpX0lekJEfXUOeXncUmMuG8eEp5WJHXl9U9yZUYA)).Arweave Bundlr کے ذریعے اپ لوڈ کردہ ٹرانزیکشن کو سپورٹ کرتا ہے، لیکن [فی الحال Bundlr مینی فیسٹس کو سپورٹ نہیں کرتا ہے](https://docs.bundlr.network/learn/gateways#indexing).
