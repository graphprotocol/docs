...
[NEAR بلاکس](https://github.com/graphprotocol/example-subgraphs/tree/main/near/blocks-example)

[NEAR ریسیپٹس](https://github.com/graphprotocol/example-subgraphs/tree/main/near/receipts-example)

## عمومی سوالات

### بیٹا جیسے کاپ کرتا ہے؟
...
### کیا ایک سب گراف دونو NEAR اور EVM چینس پر انڈیکس ہو سکتا ہے؟
...
### کیا ریسیپٹ ہینڈلرز اکاؤنٹس اور ان کے سب اکاؤنٹس کو متحرک کریں گے؟
...
### ایتھرئم سب گرافس "پینڈنگ" اور "موجودہ" ورژن کی حمایت کرتے ہیں، میں NEAR سب گراف کے "پینڈنگ" ورژن کو کیسے تعینات کر سکتا ہوں؟
