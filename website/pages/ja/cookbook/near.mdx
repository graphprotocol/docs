...
[NEAR ブロック](https://github.com/graphprotocol/example-subgraphs/tree/main/near/blocks-example)

[NEAR 領収書](https://github.com/graphprotocol/example-subgraphs/tree/main/near/receipts-example)
