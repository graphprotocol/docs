...
\#3と同様に、全体の準備状況と関係者のリソースの余裕に依存します。例えば、新しいチェーンにまったく新しいFirehoseの実装がある場合、すでにバトルテストされた統合やガバナンスプロセスの進行が進んでいる統合よりも時間がかかるかもしれません。これは特に、以前に [Hosted Service](https://thegraph.com/hosted-service) でサポートされていたチェーンや、既にテストされたスタックに依存しているチェーンに対して当てはまります。
