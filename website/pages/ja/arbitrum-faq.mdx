...
コア開発者チームは、デリゲーション、キュレーション、サブグラフの Arbitrum への移行を大幅に容易にする移行ヘルパーの作成に取り組んでいます。ネットワーク参加者は、2023 年 4 月にマイグレーションヘルパーが利用できるようになることを期待しています。

また、グラフコミュニティは、2023 年 2 月または 3 月に Arbitrum でインデックス報酬が有効になることを期待しています。
