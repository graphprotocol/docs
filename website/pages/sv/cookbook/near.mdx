...
- NEAR undergrafer introducerar en ny `typ` av datakälla (`nära`)
...
Om det är en allmän fråga om subgrafutveckling, finns det mycket mer information i resten av [utvecklardokumentationen](/cookbook/quick-start). Annars vänligen gå med i [The Graph Protocol Discord](https://discord.gg/vtvv7FP) och fråga i #near-kanalen eller maila near@thegraph.com.
