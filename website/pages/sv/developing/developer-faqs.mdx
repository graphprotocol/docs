...
## 25. Var går jag för att hitta min nuvarande subgraf på Hosted Service?
...
## 26. Kommer Hosted Service börja ta ut frågeavgifter?
...
## 27. När kommer Hosted Service att stängas ner?

Hosted service kommer att stängas ner 2023. Läs blogginlägget om tillkännagivandet [här](https://thegraph.com/blog/sunsetting-hosted-service). Alla dappar som använder hosted service uppmanas att uppgradera till det decentraliserade nätverket. Nätverksbidrag är tillgängliga för utvecklare att hjälpa till att uppgradera sin subgraf till The Graph Nätverk. Om din dapp uppgraderar en subgraf kan du ansöka [här](https://thegraph.typeform.com/to/Zz8UAPri?typeform-source=thegraph.com).

## 28. Hur uppdaterar jag en subgraf på mainnet?
