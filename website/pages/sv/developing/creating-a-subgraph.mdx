...
För Arweave kan Graph Node hämta filer baserat på deras [transaktions-id](https://docs.arweave.org/developers/server/http-api#transactions) från en Arweave-gateway ([exempelfil](https://bdxujjl5ev5eerd5ouhhs6o4kjrs4g6hqstzlci5pf6vhxezkgaa.arweave.net/CO9EpX0lekJEfXUOeXncUmMuG8eEp5WJHXl9U9yZUYA)). Arweave stöder transaktioner som laddats upp via Bundlr, men [stöder för närvarande inte Bundlr-manifest](https://docs.bundlr.network/learn/gateways#indexing).
