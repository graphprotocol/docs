...
Nếu bạn đang sử dụng ví "thông thường" như MetaMask (Tài khoản thuộc sở hữu bên ngoài hoặc EOA, tức là ví không phải là hợp đồng thông minh), thì đây là tùy chọn và bạn nên giữ cùng địa chỉ chủ sở hữu như trong L1.
...
![công cụ chuyển](/img/L2-transfer-tool1.png)
...
![Chuyển sang L2](/img/transferToL2.png)

Nhấp vào nút Chuyển sang L2 sẽ mở công cụ chuyển nơi bạn có thể bắt đầu quá trình chuyển.
...
![Bắt đầu chuyển sang L2](/img/startTransferL2.png)
...
![Màn hình chờ](/img/screenshotOfWaitScreenL2.png)
...
![Xác nhận chuyển sang L2](/img/confirmTransferToL2.png)
...
![Gửi tín hiệu tới L2](/img/sendingCurationToL2Step2First.png)
...
![Gửi tín hiệu tới L2](/img/L2TransferToolsFinalCurationImage.png)
