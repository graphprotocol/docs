...
Агент індексатора і сервіс-індексатора мають розташовуватися в інфраструктурі Graph Node. Існує багато способів налаштувати віртуальне середовище виконання для ваших компонентів індексатора; тут ми пояснимо, як запустити їх на "голому залізі" за допомогою пакетів NPM або базових кодів або через kubernetes і докер на Google Cloud Kubernetes Engine. Якщо ці приклади налаштувань не підходять для вашої інфраструктури, ймовірно, існує посібник спільноти, на який можна посилатися, то відвідайте [Discord](https://thegraph.com/discord) і скажіть "привіт"! Пам’ятайте про [стейкінг в протоколі](/network/indexing#stake-in-the-protocol) перед запуском компонентів індексатора!
