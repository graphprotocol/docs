...
Будь ласка допоможіть [протестувати мережу](https://testnet.thegraph.com/explorer) на L2 та залиште відгук про те, як все пройшло в [Discord](https://discord.gg/graphprotocol).
