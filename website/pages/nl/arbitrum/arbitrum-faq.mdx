...
Door het schalen van de protocol smart contracs het L2 netwerk op staat dat deelnemers toe frequenter interactie te kunnen hebben tegen gereduceerde gas fees. Bijvoorbeeld, Indexers kunnen allocaties vaker openen en sluiten om een groter aantal subgraphs vaker te indexeren, ontwikkelaars kunnen subgraphs gemakkelijker implementeren en upgraden, Delegators kunnen GRT vaker delegeren, en Curators kunnen signaal toevoegen of verwijderen aan een groter aantal subgraphs - acties die eerder als te duur werden beschouwd om frequent uit te voeren vanwege de gas.
