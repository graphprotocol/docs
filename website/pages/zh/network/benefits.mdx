...
The Graph的去中心化网络经过精心设计和完善，创造了强大的索引和查询体验，由于世界各地成千上万的贡献者，它每天都在变得更好。

这种去中心化协议的好处无法通过在本地运行`graph-节点`来复制。Graph网络更可靠、更高效、更便宜。
...
|         每月查询          |                受限于基础设施能力                | 30,000 (autoscaling)  |
|        每个查询的成本        |                   0美元                   |  $0.0005<sup>‡</sup>  |
|         基础设施          |                   中心化                   |         去中心化          |
| Geographic redundancy |              每个额外节点 $750 +              |         包括在内          |
|        正常工作时间         |                   变量                    |        99.9%+         |
...
|         基础设施          |                     中心化                     |         去中心化          |
|         工程费用          |                  每小时200美元                   |         包括在内          |
| Geographic redundancy |              每个额外节点的总成本为1200美元              |         包括在内          |
|        正常工作时间         |                     变量                      |        99.9%+         |
...
|          成本比较          |                     自托管                     |        Graph网络        |
|:----------------------:|:-------------------------------------------:|:---------------------:|
|      每月服务器费用 \*      |          $1100 per month, per node          |          0美元          |
|          查询成本          |                   4000美元                    |       4500美元每月        |
| Number of nodes needed |                     10                      |          不适用          |
