...
- **آپریٹر والیٹ** - آپریٹر والیٹ کا سیٹ اپ کرنا ایک اہم احتیاط ہے کیونکہ یہ ایک انڈیکسر کو اپنی کلیدوں کے درمیان علیحدگی برقرار رکھنے کی اجازت دیتا ہے جو سٹیک کو کنٹرول کرتی ہیں اور جو روزمرہ کے کاموں کے کنٹرول میں ہیں. ہدایات کے لیے [پروٹوکول میں حصہ ڈالنا](/indexing/overview/#stake-in-the-protocol) دیکھیں.
