...
## 14. ¿Es posible diferenciar entre redes (mainnet, Sepolia, local) desde los event handlers?
...
## 15. ¿Soporta block y call handlers en Sepolia?

Sí. Sepolia admite block handlers, call handlers y event handlers. Cabe señalar que los event handlers tienen mucho más rendimiento que los otros dos handlers y son compatibles con todas las redes EVM.
