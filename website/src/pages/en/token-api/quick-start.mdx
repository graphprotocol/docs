...
Make sure you already have an account on [The Graph Market](https://thegraph.market/) and an **"API TOKEN (Authentication JWT)"** from the [Dashboard](https://thegraph.market/dashboard).
