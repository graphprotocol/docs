...
export default {
  ...
  'tvm-tokens-native': titles['tvm-tokens-native'] ?? '',
  'tvm-dexs': titles['tvm-dexs'] ?? '',
  'polymarket-markets': titles['polymarket-markets'] ?? '',
  'polymarket-platform': titles['polymarket-platform'] ?? '',
  'polymarket-users': titles['polymarket-users'] ?? '',
