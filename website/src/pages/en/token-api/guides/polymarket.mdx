...
- [Market Endpoints](/token-api/polymarket-markets/markets/)
- [Platform Endpoints](/token-api/polymarket-platform/platform/)
- [User Endpoints](/token-api/polymarket-users/users/)

You can also set up the [Token API MCP](/ai-suite/token-api-mcp/introduction/) to query Polymarket in your AI assistant.
