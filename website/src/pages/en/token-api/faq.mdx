...
DEXs listed below are grouped by network and ordered by most swaps. Only verified DEXs with more than 10K swaps in 2025 have been listed. For a more detailed and comprehensive list of supported DEXs, you can query the /dexes/evm, /dexes/svm, or /dexes/tvm endpoints.
