...
# The first mnemonic is used as the primary identity on the /info endpoint.
# operator_mnemonics = [
...
[subgraphs.network]
# The Graph Network Subgraph (includes escrow data for Horizon)
