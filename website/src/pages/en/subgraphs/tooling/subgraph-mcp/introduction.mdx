...
The Subgraph MCP server allows smooth integration with [Claude](/subgraphs/tooling/subgraph-mcp/claude/), [Cline](/subgraphs/tooling/subgraph-mcp/cline/), or [Cursor](/subgraphs/tooling/subgraph-mcp/cursor/), making blockchain data queries with The Graph Network a conversational experience.
