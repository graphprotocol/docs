...
- To perform actions, a need wallet (e.g., MetaMask) connected to [Graph Explorer](https://thegraph.com/explorer).
...
![Graph Explorer Subgraphs tab](/img/explorer-subgraphs-tab.png)
...
![Signal/Un-signal on Subgraph](/img/explorer-signal.png)
...
Go to the [Participants](https://thegraph.com/explorer/participants?chain=arbitrum-one) tab to view:
...
- Indexing Rewards: This is the total indexing rewards earned by the Indexer and their Delegators over all time. Indexer rewards are paid through GRT issuance.
