...
Reach out to InfraDAO [indexing@infradao.com] or @jmulq on Telegram to discuss options that meet your technical needs.
...
If you believe your usage is incorrectly flagged or have unique use cases (e.g. approved special request pending new Subgraph upgrade plan), reach out to InfraDAO at [indexing@infradao.com](mailto:indexing@infradao.com) or `@jmulq` on Telegram.
