...
To preserve the stability of Edge & Node's Subgraph Studio and preserve the reliability of The Graph Network, the Edge & Node Team will monitor storage usage and take corresponding action with Subgraphs that have:
...
- The Subgraph remains within the free-tier storage limits
