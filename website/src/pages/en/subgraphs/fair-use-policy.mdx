...
If you believe your usage is incorrectly flagged or have unique use cases (e.g. approved special request pending new Subgraph upgrade plan), reach out to [InfraDAO](indexing@infradao.com) or `@jmulq` on Telegram.
