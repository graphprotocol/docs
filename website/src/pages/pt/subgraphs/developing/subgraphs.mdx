...
- **Acesso de Dados:** Os subgraphs permitem consultar (queries) e indexar os dados da blockchain para a web3.
...
- `mapping.ts`: Código de [Mapeamentos do AssemblyScript](https://github.com/AssemblyScript/assemblyscript) que traduz dados de eventos para entidades definidas no seu schema
...
![Vida útil de um Subgraph](/img/subgraph-lifecycle.png)

## Programação de Subgraphs
...
### Implantação no Subgraph Studio
...
### Adicione Sinal de Curadoria para Indexação
...
### Programação de Aplicativos e Queries

Os subgraphs na The Graph Network recebem 100.000 queries gratuitos por mês. Após isso, os programadores poderão [pagar por queries com GRT ou cartão de crédito](/subgraphs/billing/).
...
### Como Apagar e Transferir Subgraphs
