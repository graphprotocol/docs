...
3. Após ter feito as mudanças, lanço o meu subgraph ao Graph Node local, **_forkando o subgraph falho_** e programando o `dataSources.source.startBlock` em `6190343` no `subgraph.yaml`:
