...
Lembre-se, enquanto passas pelo seu fluxo de publicação, poderá enviar pushes para a mainnet ou o Sepolia. Se for um programador noviço de subgraph, recomendamos que comece a editar na Sepolia, que é gratuita. Isto lhe permite ver como o subgraph funcionará no The Graph Explorer e testar elementos de curadoria.
