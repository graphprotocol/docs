...
Ropsten, Rinkeby e Kovan serão depreciadas; saiba mais no [blog da Ethereum Foundation](https://blog.ethereum.org/2022/06/21/testnet-deprecation). Desde 25 de fevereiro de 2023, Ropsten, Rinkeby e Kovan não são mais apoiados pelo serviço hospedado. A Sepolia será mantida por programadores de clientes após o merge, e também tem apoio no serviço hospedado. Programadores que atualmente usam Ropsten, Rinkeby ou Kovan como seu ambiente de testes estão convidados a migrar à Sepolia.
