...
Lorsqu'un subgraph est publié sur The Graph Network, vous pouvez visiter sa page de détails sur Graph Explorer et utiliser l'onglet "Requête" pour explorer l'API GraphQL déployée pour chaque subgraph.

## Spécificités⁠

Chaque subgraph publié dans The Graph Network dispose d'une URL de requête unique dans Graph Explorer pour effectuer des requêtes directes. Vous pouvez la trouver en naviguant vers la page des détails du subgraph et en cliquant sur le bouton "Requête" dans le coin supérieur droit.
