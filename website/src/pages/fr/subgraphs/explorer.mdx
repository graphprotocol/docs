...
Graph Explorer se compose de plusieurs parties où vous pouvez interagir avec des [subgraphs](https://thegraph.com/explorer?chain=arbitrum-one), [déléguer](https://thegraph.com/explorer/delegate?chain=arbitrum-one), engager des [participants](https://thegraph.com/explorer/participants?chain=arbitrum-one), voir des [informations sur le réseau](https://thegraph.com/explorer/network?chain=arbitrum-one) et accéder à votre profil d'utilisateur.
...
Après avoir déployé et publié votre subgraph dans Subgraph Studio, accédez à [Graph Explorer](https://thegraph.com/explorer) et cliquez sur le lien "[Subgraphs](https://thegraph.com/explorer?chain=arbitrum-one)" dans la barre de navigation pour accéder aux éléments suivants :
...
- Signaler des GRT sur votre propre subgraph ou sur les subgraphs des autres pour informer les Indexeurs de son importance et de sa qualité.
  ...
  - Ceci est essentiel car la signalisation sur un subgraph l’incite à être indexé, ce qui signifie qu’il finira par apparaître sur le réseau pour répondre aux requêtes.
