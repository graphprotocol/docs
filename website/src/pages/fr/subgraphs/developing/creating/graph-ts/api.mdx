...
| 0.0.5 | AssemblyScript a été mis à niveau à niveau vers la version 0.19.10 (cela inclut des changements brusques, veuillez consulter le [`Guide de migration`](/resources/migration-guides/assemblyscript-migration-guide/))<br />`ethereum.transaction.gasUsed` renommé en `ethereum.transaction.gasLimit` |
