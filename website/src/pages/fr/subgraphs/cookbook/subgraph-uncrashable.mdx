...
- **Temps de fonctionnement continu**. Les entités mal gérées peuvent entraîner le plantage des subgraphs, ce qui peut perturber les projets qui dépendentde The Graph. Mettez en place des fonctions d'assistance pour rendre vos subgraphs “incrashable” et assurer la continuité des activités.
