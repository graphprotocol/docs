...
[NEAR](https://near.org/) est une plateforme de contrats intelligents permettant de créer des applications décentralisées. Visitez la [documentation officielle](https://docs.near.org/concepts/basics/protocol) pour plus d'informations.
