...
La [documentation des subgraphs alimentés par Substreams](/sps/introduction/) vous montrera comment les packager pour un déploiement sur The Graph.
