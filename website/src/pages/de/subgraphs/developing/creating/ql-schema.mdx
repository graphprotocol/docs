...
Die folgenden Beispiele `GravatarAccepted` und `GravatarDeclined` basieren auf Ereignissen. Es wird nicht empfohlen, Ereignisse oder Funktionsaufrufe 1:1 auf Entitäten abzubilden.
