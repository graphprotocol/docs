...
Questi sono i passi per distribuire il subgraph nel Subgraph Studio:
...
Stiamo usando la stessa CLI per distribuire i subgraph al nostro [hosted service](https://thegraph.com/hosted-service/) e nel [Subgraph Studio](https://thegraph.com/studio/). Ecco i comandi per installare graph-cli. Questa operazione può essere eseguita con npm oppure yarn.
