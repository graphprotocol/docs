...
`@graphprotocol/graph-ts` library निम्नलिखित API प्रदान करती है:
...
- IPFS से files load करने के लिए एक `ipfs` API।
- JSON data को parse करने के लिए एक `json` API।
- Cryptographic functions का उपयोग करने के लिए एक `crypto` API।
...
Store API उन इकाइयों entities को पुनः प्राप्त करने की सुविधा प्रदान करता है जो वर्तमान ब्लॉक में बनाई गई थीं या अपडेट की गई थीं। इसका एक सामान्य परिदृश्य यह है कि एक हैंडलर किसी ऑनचेन इवेंट से एक ट्रांज़ेक्शन बनाता है, और बाद में कोई अन्य हैंडलर इस ट्रांज़ेक्शन तक पहुंचना चाहता है, यदि यह मौजूद है।
...
2. बस उदाहरण के साथ entity बनाएं। `new Transfer(id)`, entity पर properties set करें, फिर इसे store पर `.save()` करें। यदि entity पहले से मौजूद है, तो परिवर्तन उसमें merge कर दिए जाते हैं।
