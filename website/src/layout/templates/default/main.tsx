  ...
  return (
    <main
      ...
      className={classNames([
        `[--graph-docs-aside-width:theme(spacing.66)] data-[template-type=open-api]:[--graph-docs-aside-width:theme(spacing.111)]
        ...
        grid
        min-h-[var(--graph-docs-viewport-height)]
    ...
    >
      ...
      <div>
        <aside
          className={`
            text-body-xsmall-tight has-nested-empty/aside-content:hidden invisible absolute inset-y-0 start-0 w-[var(--graph-docs-aside-width)]
        ...
        >
          <div
            className={`
              nested/aside-content gradient-mask-y scrollbar-thin sticky top-[var(--graph-docs-header-height)]
              max-h-[var(--graph-docs-viewport-height)] overflow-x-clip overflow-y-auto py-12 pe-6
            `}
          >
