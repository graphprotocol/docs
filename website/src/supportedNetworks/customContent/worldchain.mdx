...
### Indexing World Chain with Substreams
...
2. Scaffold a project with `substreams init` and choose the EVM path, pointing it at your World Chain contract.
