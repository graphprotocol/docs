...
Ahora puedes consultar tu subgrafo siguiendo [estas instrucciones](/developer/query-the-graph). Puedes consultar desde tu dApp si no tienes tu clave de API a través de la URL de consulta temporal gratuita con tarifa limitada que se puede utilizar para el desarrollo y la puesta en marcha. Puedes leer las instrucciones adicionales sobre cómo consultar un subgrafo desde una aplicación frontend [aqui](/developer/querying-from-your-app).
