...
1. `fork-base` es la URL "base", de modo que cuando se agrega el _subgraph id_, la URL resultante (`<fork- base>/<subgraph-id>`) es unendpoint de GraphQL válido para la tienda del subgrafo.
