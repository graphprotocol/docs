...
El segundo modo que admite `graph init` es la creación de un nuevo proyecto a partir de un subgrafo de ejemplo. The following command does this:
...
type User @entity {
  id:
  name: String!
  organizations: [Organization!]! [Organization!]! @derivedFrom(field: "members")
}
```
...
type Organization @entity {
  id:
  name: String!
  members: [UserOrganization]! [UserOrganization]! @derivedFrom(field: "user")
}

type User @entity {
  id:
  name: String!
  organizations: [UserOrganization!] [UserOrganization!] @derivedFrom(field: "organization")
}
