...
ID!
  tokenBalances:
  [TokenBalance!]! @derivedFrom(field: "token")
}
...
} [Organization!]! [Organization!]! @derivedFrom(field: "members")
}
```
...
type Organization @entity {
  ...
  members:
  name: String!
  members: [UserOrganization]! [UserOrganization]! [UserOrganization]! @derivedFrom(field: "user")
}
...
type User @entity {
  ...
  organizations:
  name: String!
  organizations: [UserOrganization!] [UserOrganization!] [UserOrganization!] @derivedFrom(field: "organization")
}
