...
So you'd like to deprecate your subgraph on The Graph Explorer. You've come to the right place! Follow the steps below: Follow the steps below:
...
5. Voila! Voila! Voila! Your subgraph will no longer show up on searches on The Graph Explorer. Please note the following:
