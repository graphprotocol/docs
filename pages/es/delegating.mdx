...
<div sx={{ mx: 'auto', maxWidth: '400px' }}>
  ![Delegation unbonding](/img/Delegation-Unbonding.png) _Ten en cuenta la tasa del 0,5% en la UI de la Delegación, así como el periodo de desvinculación de 28 días._
</div>
...
<div sx={{ mx: 'auto', maxWidth: '700px' }}>
  ![Indexing Reward Cut](/img/Indexing-Reward-Cut.png) *El Indexador de arriba está dando a los Delegadores el 90% de las recompensas generadas. El del medio está dando a los Delegadores un 20%. El de abajo está dando un ~83% a sus Delegadores*
</div>
...
## Guía de Video sobre la interfaz de Usuario de la red
