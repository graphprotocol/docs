...
This means you have used `console.log` in your code, which is not supported by AssemblyScript. Please consider using the [Logging API](https://thegraph.com/docs/en/developer/assemblyscript-api/#logging-api)
