...
Consulta la sección "Instalar un modelo de fuente de datos" en: [Plantilla para fuentes de datos](/developing/create-subgraph-hosted#data-source-templates).
...
Sí, deberías echar un vistazo a la función opcional de inicio de bloque para comenzar la indexación desde el bloque en el que se desplegó el contrato: [Start blocks](/developing/create-subgraph-hosted#start-blocks)
