---
title: Preguntas Frecuentes de los Developers
---
...
### 8. ¿Cómo me aseguro de que estoy usando la última versión de graph-node para mis deployments locales?
...
### 13. Al escuchar múltiples contratos, ¿es posible seleccionar el orden del contrato para escuchar eventos?
...
### 14. ¿Es posible diferenciar entre redes (mainnet, Goerli, local) desde los handlers de eventos?
...
### 22. ¿Es posible usar Apollo Federation encima del nodo graph-node?
...
### 23. ¿Existe un límite para la cantidad de objetos que The Graph puede devolver por consulta?
