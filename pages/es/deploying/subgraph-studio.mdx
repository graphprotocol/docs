...
Consultar subgrafos genera tarifas de consulta, que se utilizan para recompensar a los [Indexadores](/network/indexing) en The Graph Network. Si eres un dapp developer o un developer de subgrafos, Studio te permitirá crear mejores subgrafos para potenciar tus consultas o las de tu comunidad. El Studio se compone de 5 partes principales:
...
The Graph Network aún no es compatible con todas las fuentes de datos & features disponibles en el Servicio Alojado. Para ser compatibles con los Indexadores en la red, los subgrafos deben:
...
Solo podrás indexar datos de la mainnet (incluso si tu subgrafo se publicó en una testnet) porque solo los subgrafos que indexan datos de la mainnet se pueden publicar en la red. Esto se debe a que los Indexadores deben enviar registros de Prueba de Indexación obligatorios a partir de un hash de bloque específico. Debido a que publicar un subgrafo es una acción que se realiza on-chain, recuerda que la transacción puede demorar unos minutos en completarse. Cualquier dirección que utilices para publicar el contrato será la única que podrá publicar versiones futuras. ¡Elige sabiamente!
