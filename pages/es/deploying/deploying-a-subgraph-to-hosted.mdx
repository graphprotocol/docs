...
El Servicio Alojado es un indexador de Graph Node gratuito. Los developers pueden deployar subgrafos que indexen una variedad de redes, que se indexarán y estarán disponibles para consultar a través de graphQL.
