...
2. Llama a 'deprecateSubgraph' con tu 'SubgraphID'
3. Voila! Tu subgrafo ya no aparecerá en las búsquedas en The Graph Explorer. Ten en cuenta lo siguiente:

- La wallet del propietario debe llamar a la función 'deprecateSubgraph'.
