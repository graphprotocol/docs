...
Consulta la sección [Configurar la infraestructura del servidor mediante Terraform en Google Cloud](/indexing#setup-server-infrastructure-using-terraform-on-google-cloud)
...
Una vez que un indexador ha stakeado GRT en el protocolo, los [componentes del indexador](/indexing#indexer-components) pueden iniciarse y comenzar sus interacciones con la red.
