...
Esta es una guía sobre cómo migrar tu subgrafo desde el Servicio Alojado a la red descentralizada The Graph. La migración a The Graph Network ha sido exitosa para proyectos como Opyn, UMA, mStable, Audius, PoolTogether, Livepeer, RAI, Enzyme, DODO, Opyn, Pickle y BadgerDAO, todos los cuales dependen de los datos servidos por los Indexadores de la red. En la actualidad hay mas de 600 subgrafos activos en The Graph Network, que generan tarifas de consulta e indexan activamente datos de web3.
...
El Servicio Alojado fue creado para permitir a los developers deployar sus subgrafos sin ninguna restricción.
...
### Estimación de las Rarifas de Consulta en la Red
