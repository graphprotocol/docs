...
Para más información sobre cómo escribir tu subgrafo, mira [Creating a Subgraph](/developing/creating-a-subgraph).
...
Sigue [estas instrucciones](/querying/querying-the-hosted-service) para consultar tu subgrafo en el Servicio Alojado (Hosted Service).
