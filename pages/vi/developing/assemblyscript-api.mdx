...
Subgraphs được tạo với [`graph init`](/developing/creating-a-subgraph) đi kèm với các phụ thuộc được định cấu hình trước. Tất cả những gì cần thiết để cài đặt các phần phụ thuộc này là chạy một trong các lệnh sau:
