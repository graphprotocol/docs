...
Xem phần "Khởi tạo mẫu nguồn dữ liệu" trên: [Các Mẫu nguồn Dữ liệu](/developing/create-subgraph-hosted#data-source-templates).
...
Có, bạn nên xem tính năng khối bắt đầu tùy chọn để bắt đầu lập chỉ mục từ khối mà hợp đồng đã được triển khai: [Khối Bắt đầu](/developing/create-subgraph-hosted#start-blocks)
