...
Các trường truy vấn tìm kiếm toàn văn bản cung cấp một API tìm kiếm văn bản biểu đạt có thể được thêm vào subgraph và tùy chỉnh. Tham khảo [Xác định các Trường Tìm kiếm Toàn văn bản](/developing/create-subgraph-hosted#defining-fulltext-search-fields) để thêm tìm kiếm toàn văn bản vào subgraph của bạn.
