...
First follow the instructions [here](/developing/define-subgraph-hosted) to install the Graph CLI. Create a subgraph by passing in `graph init --product hosted-service`
