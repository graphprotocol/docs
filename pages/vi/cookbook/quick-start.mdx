...
Để biết thêm thông tin về cách viết subgraph của bạn, hãy xem [Tạo một Subgraph ](/developing/create-subgraph-hosted).
...
Thực hiện theo [các hướng dẫn này](/querying/query-hosted-service) để truy vấn subgraph của bạn trên Dịch vụ được lưu trữ.
