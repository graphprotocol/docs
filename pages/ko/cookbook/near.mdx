...
**schema.graphql:** 서브그래프에 저장되는 데이터와 GraphQL을 통해 쿼리하는 방법을 정의하는 스키마 파일입니다. NEAR 서브그래프에 대한 요구 사항은 [기존 문서](/developing/creating-a-subgraph#the-graphql-schema)에서 다룹니다.
...
스키마 정의는 결과 서브그래프 데이터베이스의 구조와 엔터티 간의 관계를 설명합니다. 이것은 원본 데이터 소스와 무관합니다. [여기](/developing/creating-a-subgraph#the-graphql-schema)에 서브그래프 스키마 정의에 대한 자세한 내용이 있습니다.
...
호스팅 서비스에서 서브그래프 생성 및 배포에 대한 자세한 내용은 [여기](/deploying/deploying-a-subgraph-to-hosted)에서 확인할 수 있습니다.
