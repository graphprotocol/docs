...
서브그래프를 작성하는 방법에 대한 자세한 내용은 [서브그래프 생성](/developing/create-subgraph-hosted)을 참조하십시오.
...
이제 다음 [지침들](/querying/query-the-graph)에 따라 서브그래프를 쿼리할 수 있습니다. API 키가 없는 경우 개발 및 준비에 사용할 수 있는 무료의 속도 제한 임시 쿼리 URL을 통해 dapp에서 쿼리할 수 있습니다. [여기](/querying/querying-from-your-app)에서 프런트엔드 애플리케이션에서 서브그래프를 쿼리하는 방법에 대한 추가 지침을 읽을 수 있습니다.
...
호스팅 서비스에서 서브그래프를 쿼리하기 위해 [이 지침서](/querying/query-hosted-service)를 따라하시기 바랍니다.
