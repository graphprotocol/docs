...
2. [Subgraph Studio](https://thegraph.com/studio/)에서 서브그래프를 생성합니다. 이를 수행하는 방법에 대한 가이드는 [Subgraph Studio docs](/deploying/subgraph-studio)와 [이 비디오 듀토리얼](https://www.youtube.com/watch?v=HfDgC2oNnwo)에서 찾을 수 있습니다.
...
업그레이드하려면 서브그래프의 이전 버전에서 새 버전으로 GRT를 마이그레이션해야 합니다. 이것은 모든 업그레이드에 대해 새로운 결합 곡선이 생성된다는 것을 의미합니다(결합 곡선에 대한 자세한 내용은 [여기](/network/curating#bonding-curve-101)서 확인 바랍니다).
...
[여기](/managing/deprecating-a-subgraph)의 단계들을 따라서 서브그래프를 Deprecate 하고 The Graph 네트워크로부터 제거할 수 있습니다.
...
The Graph 네트워크가 진정으로 탈중앙화되기 위해서는 쿼리 수수료가 프로토콜 인센티브의 핵심 부분으로 지불되어야 합니다. API 구독 및 쿼리 수수료 지불에 대한 자세한 내용은 [여기](/querying/billing)에서 청구 관련 문서를 확인하십시오.
...
<VideoEmbed src="https://www.youtube.com/embed/CzdQ3dFFrjo" />
