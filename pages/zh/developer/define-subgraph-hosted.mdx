...
A subgraph defines which data The Graph will index from Ethereum, and how it will store it. Once deployed, it will form a part of a global graph of blockchain data. Once deployed, it will form a part of a global graph of blockchain data. Once deployed, it will form a part of a global graph of blockchain data.
