...
An event will only be triggered when both the signature and topic 0 match. An event will only be triggered when both the signature and topic 0 match. By default, `topic0` is equal to the hash of the event signature. By default, `topic0` is equal to the hash of the event signature.
