...
有几种方法可以使用多重签名钱包发布子图。 在这里，我们将描述使用 Etherscan 在 [GNS 合约](https://etherscan.io/address/0xaDcA0dd4729c8BA3aCf3E99F3A9f471EF37b6825)中调用[ publishNewSubgraph 函数</code>](https://github.com/graphprotocol/contracts/blob/dev/contracts/discovery/GNS.sol#L231)。
