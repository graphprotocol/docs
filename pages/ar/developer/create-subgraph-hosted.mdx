...
الـ `function` هي توقيع الدالة المعياري لفلترة الاستدعاءات من خلالها. The `handler` property is the name of the function in your mapping you would like to execute when the target function is called in the data source contract.
