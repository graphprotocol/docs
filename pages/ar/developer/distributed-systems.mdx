...
فشل الاتصالات. وصول الطلبات خارج الترتيب. أجهزة الكمبيوتر المختلفة ذات الساعات والحالات غير المتزامنة تعالج الطلبات ذات الصلة. الخوادم تعيد التشغيل. حدوث عمليات إعادة التنظيم بين الطلبات. These problems are inherent to all distributed systems but are exacerbated in systems operating at a global scale.
