...
The types above are just the general ones that mappings use. You can find the full list of types for the Cosmos Hub integration [here](https://github.com/graphprotocol/graph-ts/blob/main/chain/cosmos.ts).
