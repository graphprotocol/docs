...
الـ Subgraphs التي تم إنشاؤها باستخدام [ `graph init` ](/developing/create-subgraph-hosted) تأتي مع dependencies مكونة مسبقا. كل ما هو مطلوب لتثبيت هذه الـ dependencies هو تشغيل أحد الأوامر التالية:
