...
**سکیما.گراف کیو ایل**:ایک گراف کیو ایل اسکیما ہے جو بیان کرتا ہے کےآپ کے سب گراف کے لیے کونسا ڈیٹا ذخیرہ ہے، اور اسے استفسار کیسے کرنا ہے گراف کیو ایل کا استئمال کرتے ہوۓ.
...
یہ نوٹ کرنا ضروری ہے کہ کوزموس پیغامات سلسلہ کے لحاظ سے مخصوص ہوتے ہیں اور انہیں سیریلائزڈ

پروٹوکول بفرز</a کی شکل میں سب گراف میں منتقل کیا جاتا ہے۔ > پے لوڈ۔ نتیجے کے طور پر، میسج ڈیٹا کو میپنگ فنکشن میں ڈی کوڈ کرنے کی ضرورت ہے اس سے پہلے کہ اس پر کارروائی کی جا سکے.</p> 

سب گراف میں پیغام کے ڈیٹا کو ڈی کوڈ کرنے کے طریقے کی ایک مثال [ یہاں](https://github.com/graphprotocol/example-subgraphs/blob/main/cosmos/validator-delegations/src/decoding.ts) مل سکتی ہے.
...
## ایک کوزموس سب گراف کو استفسار کرنا
...
[بلاک فلٹرنگ کی مثال](https://github.com/graphprotocol/example-subgraphs/tree/main/cosmos/block-filtering)

[ویلیڈیٹر کے انعامات کی مثال](https://github.com/graphprotocol/example-subgraphs/tree/main/cosmos/validator-rewards)

[ویلیڈیٹر ڈیلیگیشنز کی مثال](https://github.com/graphprotocol/example-subgraphs/tree/main/cosmos/validator-delegations)

[اوسموسس ٹوکن سویپس کی مثال](https://github.com/graphprotocol/example-subgraphs/tree/main/cosmos/osmosis-token-swaps)
