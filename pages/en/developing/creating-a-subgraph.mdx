...
> Note: You cannot use `@derivedFrom` fields in subgraph mappings. It will compile, but throw an `unexpected null wasm` error during runtime. See: [#219](https://github.com/graphprotocol/graph-ts/issues/219)
