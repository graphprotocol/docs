...
Subgraphs created with [`graph init`](/developing/create-subgraph-hosted) come with preconfigured dependencies. All that is required to install these dependencies is to run one of the following commands:
