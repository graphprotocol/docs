...
Once your subgraph has been [deployed to the Subgraph Studio](/deploying/deploy-subgraph-studio), you have tested it out, and are ready to put it into production, you can then publish it to the decentralized network.
