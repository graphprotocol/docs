...
For more information on how to write your subgraph, see [Create a Subgraph](/developing/create-subgraph-hosted).
...
Follow [these instructions](/querying/query-hosted-service) to query your subgraph on the Hosted Service.
