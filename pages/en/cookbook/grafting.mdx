...
The schema simply defines the database schema for how you want to store data. The resulting GraphQL schema is generated based on it.
...
```
$ graph codegen # generates types from the schema file and ABI identified in the manifest
...
The graft replacement subgraph.yaml will have a new contract address
