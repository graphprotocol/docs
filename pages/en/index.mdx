...
>
  {[
    ...
    {
      title: 'Migrate from Hosted Service',
...
>
  {[
    ...
    <Flex.Column as="li" key={index}>
      <div sx={{ mb: Spacing.L }}>
        <img src={role.image} alt="" sx={{ mb: Spacing.L, width: '96px', height: '96px' }} />
        <Text as="h3" weight="SemiBold" size="20px" sx={{ textShadow: Glow.S }}>
          {role.title}
        </Text>
      ...
      <Text as="div" weight="SemiBold" size="16px" sx={{ mt: 'auto' }}>
        <LinkInline href={role.href}>Read more</LinkInline>
      </Text>
    </Flex.Column>
  ))}
</ul>
...
>
  {[
    ...
    <Flex.Column as="li" key={index}>
      ...
      <Text as="div" weight="SemiBold" size="16px" sx={{ mt: 'auto' }}>
        <LinkInline href={product.href}>Read more</LinkInline>
      </Text>
    </Flex.Column>
  ))}
</ul>
        ...
        <Text as="div" size="14px" color="White48" sx={{ textAlign: 'center' }}>
          ...
          >
            <img
              src={network.image}
              alt=""
              sx={{ mb: Spacing.M, width: '40px', height: '40px', transition: 'transform 200ms' }}
            />
            {network.title}
          </Link>
        </Text>
