...
> TODO link to example -> do we need a new Kubernetes example?
...
> TODO: pointers on basic and "scaled" specs
...
> TODO: recommendations on a basic setup, and then when / how to scale
...
> TODO: more guidance on when sharding might be useful, any pitfalls, recommendations

> TODO: guidance on database connections?
...
> TODO: link to example of Kubernetes setup

> TODO: guidance on monitoring and managing Kubernetes deployments
...
> TODO: more detail on logging configuration?

### Monitoring & alerting

Graph Node provides the metrics via Prometheus endpoint on 8040 port by default. 

> TODO: information on running Prometheus

Grafana can then be used to visualise these metrics.

> TODO: information on running Grafana, and example dashboard configuration

> TODO: guidance on setting up alerting?
...
> TODO: examples of useful queries
...
> TODO: link to example Grafana with a breakdown of indexing time
...
> TODO: details on specific recoverable issues (database unavailable? poisoned by previous?)
...
> TODO: details on using `qlogs`, and identifying slow queries

`GRAPH_LOG_QUERY_TIMING` can also be enabled to help identify and debug slow queries.
...
> TODO: specific examples on index changes which can help with slow queries

#### Subgraph pruning (experimental!)

> TODO: document pruning

### Removing subgraphs

At some point an indexer might want to remove a given subgraph.

> TODO: document subgraph removal (new `graphman` command?)