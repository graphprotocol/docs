...
To ensure economic security of The Graph Network and the integrity of data being queried, participants stake and use Graph Tokens ([GRT](/tokenomics)). GRT is an ERC-20 work token used to allocate resources in the network.
