...
Note that supported action types for allocation management have different input requirements: `Allocate` - allocate stake to a specific subgraph deployment
