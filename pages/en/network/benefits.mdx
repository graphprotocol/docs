...
|   Engineering time†   |             $400 per month              |       Included       |
...
|   Engineering time†   |                    $800 per month                    |    Included    |
...
|   Engineering time†    |         $6,000 or more per month          | Included         |
...
|         Uptime         |                  Varies                   | 99.9%+           |
|  Total Monthly Costs   |    <span className="highlight-row" />     |
|   $1,650+ per month    |              $750 per month               |
