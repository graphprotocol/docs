...
Yes, there will be migration grant pools for each new chain enabled on the decentralized network, just as there has been for Ethereum subgraphs. The Graph Foundation is still in the process of narrowing down the amount of each chain's grant pool but, rest assured, there will be help to bootstrap curation signal and help with the cost for some initial query fees for early migrants. If you're interested in a migration grant, please contact the community at [migration@thegraph.foundation](mailto:migration@thegraph.foundation).
...
Yes, The Graph Foundation plans to continue awarding grants to subgraphs that migrate early to the decentralized network. [Migration grants](https://thegraph.typeform.com/to/Zz8UAPri?typeform-source=thegraph.com) are available to support subgraph developers migrating their subgraphs to the decentralized network. If you need any help with the migration process, please reach out to migration@thegraph.foundation.
